        ...
        render: (text, record, index) => {
          let content = (
            <div style={{width:"150px"}}>
              <p>{tu('trc20_fire_title')}</p>
              <p style={{textAlign:'right',color:"#C53028"}}>{activeLanguage === "zh" ? <a href="" target="_blank">{tu('learn_more')}</a> : <a href="" target="_blank">{tu('learn_more')}</a>} ></p>
            </div>
          );
          return (
