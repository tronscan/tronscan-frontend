    ...
    if ("SHA-1" === c) {
      ...
      if (q = function q(a, b) {
        ...
        if ("SHA-224" === c) {
          ...
          a = [e[0].a, e[0].b, e[1].a, e[1].b, e[2].a, e[2].b, e[3].a, e[3].b, e[4].a, e[4].b, e[5].a, e[5].b, e[6].a, e[6].b, e[7].a, e[7].b];
        } else {
          throw Error("Unexpected error in SHA-2 implementation");
        }
        return a;
    ...
    switch (c) {
      ...
      case "TEXT":
        c = function c(_c2, h, d) {
          ...
          q = d >>> 3;
          if ("UTF8" === a) {
            for (t = -1 === b ? 3 : 0, f = 0; f < _c2.length; f += 1) {
            ...
            for (t = -1 === b ? 2 : 0, l = "UTF16LE" === a && 1 !== b || "UTF16LE" !== a && 1 === b, f = 0; f < _c2.length; f += 1) {
              g = _c2.charCodeAt(f);
