...
var timeInterval = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(eventName, ms, fn) {
        var timerName;
...
export function parseAbi(abiArray, _ref2) {
    ...
    abiArray.forEach(function (item) {
        if (item.type == 'function') {
            returnObj[item.name] = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
                var arrInputs,
                    arrOutputs,
                    params,
                    paramInputTypes,
            ...
            returnObj[item.name].sendTransaction = function () {
                var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(transaction, pk) {
                    ...
                    return _regeneratorRuntime.wrap(function _callee3$(_context3) {
                        while (1) {
                            switch (_context3.prev = _context3.next) {
                                case 0:
                                    _context3.next = 2;
                                    return signTransaction(pk, transaction);
