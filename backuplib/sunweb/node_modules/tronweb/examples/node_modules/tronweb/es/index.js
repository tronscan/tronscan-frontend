...
import { signTransaction as _signTransaction, pkToAddress } from './utils/crypto';
...
var TronWeb = function () {
            ...
            return _regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/getaccount', {
            ...
            return _regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/getnowblock');
    ...
    TronWeb.prototype.getBlock = function () {
        var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(hashStringOrBlockNumber) {
            var data;
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            _context3.next = 4;
                            return xhr.post(this.apiUrl + '/wallet/getblockbyid', { value: hashStringOrBlockNumber });
                        ...
                        case 7:
                            ...
                            _context3.next = 10;
                            return xhr.post(this.apiUrl + '/wallet/getblockbynum', { num: hashStringOrBlockNumber });
    ...
    TronWeb.prototype.getBlockTransactionCount = function () {
        var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(hashStringOrBlockNumber) {
            var _ref7, data;
            ...
            return _regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            _context5.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/gettransactionbyid', { value: id });
            ...
            return _regeneratorRuntime.wrap(function _callee6$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            _context6.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/totaltransaction');
    ...
    TronWeb.prototype.sendTransaction = function () {
        var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(from, to, amount, privateKey) {
    ...
    TronWeb.prototype.createTransaction = function () {
        var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(to_address, owner_address, amount) {
            var _ref14, data;
            ...
            return _regeneratorRuntime.wrap(function _callee8$(_context8) {
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            _context8.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/createtransaction', {
    ...
    TronWeb.prototype.signTransaction = function () {
        var _ref15 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(transaction, privateKey) {
                ...
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        case 0:
                            ...
                            return _context9.abrupt('return', _signTransaction(privateKey, transaction));

                        case 4:
                            _context9.next = 6;
                            return xhr.post(this.apiUrl + '/wallet/gettransactionsign', {
    ...
    TronWeb.prototype.sendRawTransaction = function () {
        var _ref17 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee10(signTransaction) {
            var _ref18, data;
            ...
            return _regeneratorRuntime.wrap(function _callee10$(_context10) {
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        case 0:
                            _context10.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/broadcasttransaction', signTransaction);
    ...
    TronWeb.prototype.updateAccount = function () {
        var _ref19 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11(account_name, owner_address) {
            var _ref20, data;
            ...
            return _regeneratorRuntime.wrap(function _callee11$(_context11) {
                while (1) {
                    switch (_context11.prev = _context11.next) {
                        case 0:
                            _context11.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/updateaccount', {
    ...
    TronWeb.prototype.voteWitnessAccount = function () {
        var _ref21 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee12(owner_address, votes) {
                ...
                while (1) {
                    switch (_context12.prev = _context12.next) {
                        case 0:
                            ...
                            _context12.next = 3;
                            return xhr.post(this.apiUrl + '/wallet/votewitnessaccount', {
                                owner_address: address2HexString(owner_address),
                                votes: newVotes
                            });
    ...
    TronWeb.prototype.createToken = function () {
        var _ref23 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee13(oToken) {
                ...
                while (1) {
                    switch (_context13.prev = _context13.next) {
                        case 0:
                            ...
                            _context13.next = 8;
                            return xhr.post(this.apiUrl + '/createassetissue', {
    ...
    TronWeb.prototype.createAccount = function () {
        var _ref25 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee14(owner_address, account_address) {
            var _ref26, data;
            ...
            return _regeneratorRuntime.wrap(function _callee14$(_context14) {
                while (1) {
                    switch (_context14.prev = _context14.next) {
                        case 0:
                            _context14.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/createaccount', {
                                owner_address: address2HexString(owner_address),
    ...
    TronWeb.prototype.createWitness = function () {
        var _ref27 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee15(owner_address, url) {
            var _ref28, data;
            ...
            return _regeneratorRuntime.wrap(function _callee15$(_context15) {
                while (1) {
                    switch (_context15.prev = _context15.next) {
                        case 0:
                            _context15.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/createwitness', {
                                owner_address: address2HexString(owner_address),
                                url: stringUtf8toHex(url)
                            });
    ...
    TronWeb.prototype.transferAsset = function () {
        var _ref29 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee16(options) {
                ...
                while (1) {
                    switch (_context16.prev = _context16.next) {
                        case 0:
                            ...
                            _context16.next = 6;
                            return xhr.post(this.apiUrl + '/wallet/transferasset', {
    ...
    TronWeb.prototype.easytransfer = function () {
        var _ref31 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee17(passPhrase, toAddress, amount) {
            var _ref32, data;
            ...
            return _regeneratorRuntime.wrap(function _callee17$(_context17) {
                while (1) {
                    switch (_context17.prev = _context17.next) {
                        case 0:
                            _context17.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/easytransfer', {
    ...
    TronWeb.prototype.createAddress = function () {
        var _ref33 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee18(password) {
            var _ref34, data;
            ...
            return _regeneratorRuntime.wrap(function _callee18$(_context18) {
                while (1) {
                    switch (_context18.prev = _context18.next) {
                        case 0:
                            _context18.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/createaddress', {
    ...
    TronWeb.prototype.participateAssetIssue = function () {
        var _ref35 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee19(options) {
                ...
                while (1) {
                    switch (_context19.prev = _context19.next) {
                        case 0:
                            ...
                            _context19.next = 6;
                            return xhr.post(this.apiUrl + '/wallet/participateassetissue', {
    ...
    TronWeb.prototype.freezeBalance = function () {
        var _ref37 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee20(owner_address, frozen_balance, frozen_duration) {
            var _ref38, data;
                ...
                while (1) {
                    switch (_context20.prev = _context20.next) {
                        case 0:
                            owner_address = address2HexString(owner_address);
                            _context20.next = 3;
                            return xhr.post(this.apiUrl + '/wallet/freezebalance', {
                                owner_address: owner_address,
    ...
    TronWeb.prototype.unfreezeBalance = function () {
        var _ref39 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee21(owner_address) {
            var _xhr$post, data;
            ...
            return _regeneratorRuntime.wrap(function _callee21$(_context21) {
                while (1) {
                    switch (_context21.prev = _context21.next) {
                        case 0:
                            owner_address = address2HexString(owner_address);
                            _xhr$post = xhr.post(this.apiUrl + '/wallet/unfreezebalance', {
                                owner_address: owner_address
                            }), data = _xhr$post.data;
    ...
    TronWeb.prototype.unfreezeAsset = function () {
        var _ref40 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee22(owner_address) {
            var _ref41, data;
                ...
                while (1) {
                    switch (_context22.prev = _context22.next) {
                        case 0:
                            owner_address = address2HexString(owner_address);
                            _context22.next = 3;
                            return xhr.post(this.apiUrl + '/wallet/unfreezeasset', {
                                owner_address: owner_address
                            });
    ...
    TronWeb.prototype.withdrawBalance = function () {
        var _ref42 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee23(owner_address) {
            var _ref43, data;
                ...
                while (1) {
                    switch (_context23.prev = _context23.next) {
                        case 0:
                            owner_address = address2HexString(owner_address);
                            _context23.next = 3;
                            return xhr.post(this.apiUrl + '/wallet/withdrawbalance', {
                                owner_address: owner_address
                            });
    ...
    TronWeb.prototype.updateAsset = function () {
        var _ref44 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee24(options) {
                ...
                while (1) {
                    switch (_context24.prev = _context24.next) {
                        case 0:
                            ...
                            url = stringUtf8toHex(url);
                            _context24.next = 6;
                            return xhr.post(this.apiUrl + '/wallet/updateasset', {
    ...
    TronWeb.prototype.listNodes = function () {
        var _ref46 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee25() {
            var _ref47, data;
            ...
            return _regeneratorRuntime.wrap(function _callee25$(_context25) {
                while (1) {
                    switch (_context25.prev = _context25.next) {
                        case 0:
                            _context25.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/listnodes');
    ...
    TronWeb.prototype.getAssetIssueByAccount = function () {
        var _ref48 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee26(address) {
            var _ref49, data;
                ...
                while (1) {
                    switch (_context26.prev = _context26.next) {
                        case 0:
                            address = address2HexString(address);
                            _context26.next = 3;
                            return xhr.post(this.apiUrl + '/wallet/getassetissuebyaccount', { address: address });
    ...
    TronWeb.prototype.getAccountNet = function () {
        var _ref50 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee27(address) {
            var _ref51, data;
                ...
                while (1) {
                    switch (_context27.prev = _context27.next) {
                        case 0:
                            address = address2HexString(address);
                            _context27.next = 3;
                            return xhr.post(this.apiUrl + '/wallet/getaccountnet', { address: address });
    ...
    TronWeb.prototype.getAssetIssueByName = function () {
        var _ref52 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee28(value) {
            var _ref53, data;
                ...
                while (1) {
                    switch (_context28.prev = _context28.next) {
                        case 0:
                            ...
                            _context28.next = 3;
                            return xhr.post(this.apiUrl + '/wallet/getassetissuebyname', { value: value });
    ...
    TronWeb.prototype.getBlockByLimitNext = function () {
        var _ref54 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee29(startNum, endNum) {
            var _ref55, data;
            ...
            return _regeneratorRuntime.wrap(function _callee29$(_context29) {
                while (1) {
                    switch (_context29.prev = _context29.next) {
                        case 0:
                            _context29.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/getblockbylimitnext', { startNum: startNum, endNum: endNum });
    ...
    TronWeb.prototype.getBlockByLatestNum = function () {
        var _ref56 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee30(num) {
            var _ref57, data;
            ...
            return _regeneratorRuntime.wrap(function _callee30$(_context30) {
                while (1) {
                    switch (_context30.prev = _context30.next) {
                        case 0:
                            _context30.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/getblockbylatestnum', { num: num });
    ...
    TronWeb.prototype.listWitNesses = function () {
        var _ref58 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee31() {
            var _ref59, data;
            ...
            return _regeneratorRuntime.wrap(function _callee31$(_context31) {
                while (1) {
                    switch (_context31.prev = _context31.next) {
                        case 0:
                            _context31.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/listwitnesses');
    ...
    TronWeb.prototype.getAssetIssueList = function () {
        var _ref60 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee32() {
            var _ref61, data;
            ...
            return _regeneratorRuntime.wrap(function _callee32$(_context32) {
                while (1) {
                    switch (_context32.prev = _context32.next) {
                        case 0:
                            _context32.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/getassetissuelist');
    ...
    TronWeb.prototype.getPaginateDassetIssueList = function () {
        var _ref62 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee33(offset, limit) {
            var _ref63, data;
            ...
            return _regeneratorRuntime.wrap(function _callee33$(_context33) {
                while (1) {
                    switch (_context33.prev = _context33.next) {
                        case 0:
                            _context33.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/getpaginatedassetissuelist', { offset: offset, limit: limit });
    ...
    TronWeb.prototype.getNextMainteNanceTime = function () {
        var _ref64 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee34() {
            var _ref65, data;
            ...
            return _regeneratorRuntime.wrap(function _callee34$(_context34) {
                while (1) {
                    switch (_context34.prev = _context34.next) {
                        case 0:
                            _context34.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/getnextmaintenancetime');
    ...
    TronWeb.prototype.easyTransferByPrivate = function () {
        var _ref66 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee35(privateKey, toAddress, amount) {
            var _ref67, data;
                ...
                while (1) {
                    switch (_context35.prev = _context35.next) {
                        case 0:
                            ...
                            toAddress = address2HexString(toAddress);
                            _context35.next = 4;
                            return xhr.post(this.apiUrl + '/wallet/easytransferbyprivate', {
    ...
    TronWeb.prototype.generateAddressOnLine = function () {
        var _ref68 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee36() {
            var _ref69, data;
            ...
            return _regeneratorRuntime.wrap(function _callee36$(_context36) {
                while (1) {
                    switch (_context36.prev = _context36.next) {
                        case 0:
                            _context36.next = 2;
                            return xhr.post(this.apiUrl + '/wallet/generateaddress');
    ...
    TronWeb.prototype.generateAddressOnClient = function () {
        var _ref70 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee37() {
            var data;
    ...
    TronWeb.prototype.validateAddress = function () {
        var _ref71 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee38(address) {
            var _ref72, data;
                ...
                while (1) {
                    switch (_context38.prev = _context38.next) {
                        case 0:
                            address = address2HexString(address);
                            _context38.next = 3;
                            return xhr.post(this.apiUrl + '/wallet/validateaddress', { address: address });
    ...
    TronWeb.prototype.deployContract = function () {
        var _ref73 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee39(options) {
    ...
    TronWeb.prototype.getContract = function () {
        var _ref75 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee40(contractAddress) {
            var _ref76, data;
    ...
    TronWeb.prototype.triggerSmartContract = function () {
        var _ref77 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee41(options) {
    ...
    TronWeb.prototype.getEventResult = function () {
        var _ref79 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee42(_ref80) {
    ...
    TronWeb.prototype.contract = function contract(abiArray) {
        ...
        return {
            abi: abiArray,
            at: function () {
                var _ref81 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee43(address) {
                        ...
                        while (1) {
                            switch (_context43.prev = _context43.next) {
                                ...
                                case 3:
                                    ...
                                    abiObj = parseAbi.call(_this, abiArray, { contract_address: contract_address, owner_address: _this.defaultAccount });
            ...
            new: function () {
                var _ref83 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee44(options, pk) {
    ...
    TronWeb.prototype.sendTransactionByWallet = function sendTransactionByWallet(options, callback) {
        ...
        if (document) {
            ...
            if (oTronWallet) {
                ...
                var timer = setInterval(_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee45() {
