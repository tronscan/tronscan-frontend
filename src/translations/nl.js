export const messages = {
    ...
    */
    ...
    "reset": "Reset",
    "error": "Fout",
    "unlock_keyFile": "Sleutelbestand ontgrendelen",
    "enter_password_message": "Er is geen wachtwoord ingevoerd.",
    "password_incorrect": "Wachtwoord onjuist",
    "try_again": "probeer nogmaals",
    "wallet_unlocked": "Portemonee ontgrendeld",
    "weak": "zwak",
    "okay": "redelijk",
    "good": "goed",
    "strong": "sterk",
    ...
    "enable_desktop_notifications": "Desktop meldingen inschakelen",
    ...
    */
    ...
    "markets": "Markten",
    "tools": "Gereedschap",
    "transaction_viewer": "Transactie overzicht",
    ...
    */
    ...
    "first_node_sync_message": "Wachten op eerste node synchronisatie, probeer het over enkele minuten nogmaals.",
    ...
    */
    ...
    "permitted_characters_message": "De naam bevat ongeldige karakters, alleen a-z, A-Z en 0-9 zijn toegestaan.",
    ...
    "information_message_1": "Wanneer je TRX aanvraagt, ontvangt 10.000 TRX om mee te kunnen testen op het testnet.",
    ...
    "token_balances": "token saldi",
    "produced_blocks": "geproduceerde blokken",
    "voters": "stemmers",
    "progress": "Voortgang",
    ...
    "network": "netwerk",
    "current": "huidig",
    "trx_received": "TRX ontvangen",
    "test_trx_temporarily_unavailable_message": "Test TRX is tijdelijk niet beschikbaar. Probeer het later nogmaals.",
   ...
   Na deze periode kunnen de TRX ontgrendeld worden en kunnen de tokens weer verhandeld worden.`,
    "trx_amount": "TRX hoeveelheid",
    "token_freeze_confirm_message_0": "Ik bevestig dat ik ",
    "token_freeze_confirm_message_1": "wil vastzetten voor tenminste 3 dagen.",
    "frozen_supply": "Vastgezette voorraad",
    "tokens_unfrozen": "Tokens ontgrendeld",
    "success_tokens_unfrozen_message": "De tokens zijn ontgrendeld",
    "unable_to_unfreeze": "Het is niet mogelijk om te ontgrendelen",
    "Unable_tokens_unfrozen_message": "Het is niet mogelijk om tokens te ontgrendelen.",
    "tokens_frozen": "Vastgezette tokens",
    "successfully_frozen": "Vastzetten is voltooid",
    "name_changed": "Naam is gewijzigd",
    "successfully_changed_name_to_message": "De naam is gewijzigd in ",
    "unable_to_rename_title": "Het is niet mogelijk de naam te wijzigen",
    "unable_to_rename_message": "Er is iets fout gegaan bij het wijzigen van de naam. Probeer het later nogmaals.",
    ...
    */
    ...
    "go_to_votelist": "Ga naar stemmenlijst",
    ...
    "unable_to_change_website_title": "Het is niet mogelijk de URL te wijzigen",
    "unable_to_change_website_message": "Er is iets misgegaan tijdens het bijwerken van de website. Probeer het later nogmaals",
    "successfully_linked_github": "Succesvol aan Github gekoppeld!",
    ...
    */
    ...
    "quote_token_amount": "Quote Token hoeveelheid",
    "base_token_amount": "Base Token hoeveelheid",
    "creating_a_token": "Token wordt gemaakt",
    "available": "beschikbaar",
    "testnet": "Testnet",
    "days_to_freeze": "Dagen om vast te zetten",
    "trx_token_fee_message": "Er is 1024 TRX verschuldigd om een nieuwe token uit te geven",
    "trx_token_account_limit": "Je kunt slechts één token per account maken",
    ...
    "fill_a_valid_number": "Voer een geldig nummer in",
    "fill_a_valid_address": "Voer een geldig adres in",
    "make_another_transaction": "Maak nog een transactie aan",
    "token_exchange_confirm": "Ik bevestig dat ik {trxAmount} verschuldigd ben voor de token distributie en dat ik in ruil daarvoor {tokenAmount} krijg.",
    ...
    */
    ...
    "please_keep_in_mind": "LET OP: je account is alleen in gebruik voor testnet. Stuur geen TRX vanaf je eigen portemonee of exchange naar dit testnet address.",
    "tron_foundation": "TRON Foundation",
    "trx_for_testing": "TRX om mee te testen wordt aan uw account toegeschreven nadat u zich succesvol via account beheer heeft aangemeld.",
    "dear_users": "Beste gebruikers,",
    "finished": "Afgerond",
    "token": "token",
    "url": "url",
    "need_to_login": "Je moet ingelogd zijn om de account pagina te kunnen openen",
   ...
   De eindstemming vindt om middernacht plaats en de presentielijst wordt bijgewerkt.`,
    "search_address": "Zoeken naar adres`",
    "token_transactions": "Token transacties",
    "token_holders": "Token houders",
    "nr_of_Transfers": "Aantal overschrijvingen",
    "not_signed_in": "U dient ingelogd zijn om gebruik te maken van deze functionaliteit",
    "loading_map": "Kaart wordt geladen",
    ...
    */
    ...
    "errors_in_form": "Het formulier bevat fouten",
    "token_link_message_0": "De tokens zullen binnen enkele minuten op de ",
    "token_link_message_1": "Tokens pagina",
    "token_link_message_2": "beschikbaar zijn",
    "description_error_message_0": "De beschrijving van het token mag niet meer dan 200 tekens bevatten.",
    ...
    */
    ...
    "click_to_start_voting": "Klik hier om te beginnen met stemmen",
    ...
    "need_min_trx_to_vote_message": "U hebt tenminste 1 TRX nodig om te kunnen stemmen.",
    ...
    */
    ...
    "transaction_error_message": "Er is iets misgegaan tijdens het verzenden van deze transactie",
   ...
   "open_wallet": "Sign in",
    ...
    "login_mobile": "Login met een mobiel toestel",
    ...
    "make_a_backup_message_0": "Voor het geval uw computer kapot gaat.",
