 ...
 */
  ...
  "Appeal": "request",
  "input_market": "Record in to TRXMARKET",
  ...
  "contract_address_placeholder": "address of the contract for creating the token",
  ...
  "black_6": "Project is dismissed; Community, social media, and official website have gone over 30 days withou maintenance",
  "black_7": "Team voluntarily takes down the project due to its current progress and strategy adjustment ",
 ...
 "transaction_create_successful":"Transaction successfully created, pending signature",
 "transaction_create_failed":"Creation of transaction failed, please try again later.",
 "transaction_signature_muti_failed":"Signature failed, please try again later.",
 "transaction_signature_muti_successful":"Signed successfully",
 "signature_privilege":"Owner access",
 "signature_privilege_desc":"Owner access has the highest clearence and can be used to control users' ownerships and adjust access structure. Owner access also allows users to execute all contracts.",
 ...
 "signature_address_not_similar":"Account addresses under the same access group must be different.",
 "signature_owner_permissin_name_required":"Access name is required",
 "signature__less_threshold_owner":" The sum of the addresses' weights must be over the threshold in order to add new access",
 "signature__less_threshold_active":" The sum of the addresses' weights must be over the threshold in order to add new access",
 ...
 "signature_set_spend_trx":"Submitting changes will alter the setting of multi-signature access structure and costs ",
 ...
 "signature_my":"My Signature",
  ...
  "signature_active_permission_name_required":"Threshold of owner access is required",
