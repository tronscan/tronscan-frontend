...
export const messages = {
  ...
  */
  ...
  "ledger_note_message_4": "Features unavailable currently: TRC20 token transfer, unfreeze TRC10 tokens, token creation, Poloni DEX, SR application, SR rewards application, Github update, trading pair creation, capital injection and capital withdrawal.",
...
*/
  ...
  */
  ...
  "verify_code3":"Tronscan respects the ownership of the developers (or the owner) of the source code. We are morally as well as legally obligated to ensure that the code will only be used within the service we procide.",
 ...
 */
  ...
  */
  ...
  "trc20_footer_standard_5": "Note: The right to interpret the fee standard is owned by Poloni DEX, and Poloni DEX reserves the right to adjust the rate.",
  ...
  */
  ...
  "Singapore": "Singapore",
  "table_info_new_tip": "If you would like to look up other statistics, we recommend that you change the selected duration of time.",
 ...
 */
  ...
  "token_input_success_trx_market": "fill in 10 more items to be recorded in Poloni DEX",
