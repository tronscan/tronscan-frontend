...
*/
  ...
  "verify_code3":"Tronscanは、ソースコードの作者（または著作権所有者）によるコードの所有権を完全に尊重し、契約ソースコードの作者に保証する道徳的、倫理的、法的義務を負っています。",
  "verify_code4":"サービスの範囲内でのみ使用する",
  "verify_code5":"当社のサービスに従った当社の一般的な利用規約に従います。",
