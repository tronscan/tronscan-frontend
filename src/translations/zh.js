export const messages = {
  ...
  */
  ...
  information_message_3:
    "成功请求TRX。 如果您没有收到任何TRX，那么现在没有可用的测试TRX，请您稍后再试。",
  ...
  */
  ...
  apply_for_delegate_predescription:
    "每个代币持有者都有机会成为TRON超级代表。然而，为了让网络和社区更加平稳有效地运作，我们制定了一套标准和规定，让符合条件的合伙人成为超级代表推荐人。我们以推荐超级代表的形式，增加他们当选的机会。新推荐的超级代表每周更新并发布一次。",
  apply_for_delegate_description:
    "每个代币持有者都可以通过账户管理页面，申请成为超级代表候选人，或是在投票页面为候选人投票。每个用户可以为多个候选人投票，最高投票数必须少于或者等于持有TRX的数量。投票结果以每名用户的最终投票结果为准，票数会在每天的02:00(GMT+8)，08:00(GMT+8)，14:00(GMT+8)，20:00(GMT+8)刷新，用户也可以查看实时票数。票数最高的前27名候选人可以成为超级代表，超级代表负责打包交易出块，每次出块奖励16个TRX。27个超级代表和前100名代表合伙人也可以根据票数获得节点奖励。申请成为候选人需要一次性扣除9,999TRX的手续费，用户为超级代表候选人投票不消耗TRX。",
  apply_for_delegate_predescription_1:
    "每个代币持有者都有机会成为TRON超级代表。花费9,999TRX的申请费之后，你就成为超级代表候选人。超级代表候选人可以接受用户的投票。",
  apply_for_delegate_predescription_2:
    "票数最高的前27名候选人可以成为超级代表，超级代表负责打包交易出块，每次出块奖励16TRX。",
  apply_for_delegate_predescription_3:
    "27个超级代表和前100名超级代表合伙人也可以根据票数获得节点奖励。",
  unknown_error: "发生未知错误",
  representative_understand: "我已了解如何成为波场超级代表",
  generate_account: "点击生成账户密码及地址",
  create_account_confirm_1:
    "我已了解如果忘记或丢失密码，将不能登录账户查看资产。",
  create_account_confirm_2:
    "我已了解如果忘记或丢失密码，没有任何方式可以找回。",
  ...
  visit_third_party_website:
    "您所访问的页面将跳转到第三方网站，可能存在安全风险，确定要继续吗?",
  url_changed: "网址已变更",
  ...
  create_sr_landing_page_message_0:
    "超级代表可以创建一个着陆页，在该页面上他们可以分享有关其团队和计划的更多信息",
  set_github_url_message_0:
    "你已经配置你的Github模板了吗？ 然后可以使用下面的按钮设置URL",
  ...
  */
  ...
  token_exchange_confirm:
    "确认花费 {trx数额} 用于认购通证，总计获得{通证数额} 个代币。",
  ...
  */
  ...
  search_trading_area_tip:
    "只需一些基础信息即可在Poloni DEX创建交易对，用户将可以通过搜索进行交易",
  list_trading_area: "申请正式上币",
  list_trading_area_tip:
    "提供通证详细信息并通过Poloni DEX团队审核后，您的通证将在Poloni DEX正式上线交易",
  not_entry: "未创建",
  not_entry_list: "未申请",
  to_audit: "待审核",
  ...
  */
  ...
  please_keep_in_mind:
    "请注意，您注册的账户地址只用于测试网，请勿通过钱包或交易所向测试网地址进行转账。",
  ...
  */
  ...
  unable_load_representatives_page_message:
    "页面加载失败，可能原因为地址无效、非超级代表地址或超级代表尚未设置此页面。",
  ...
  */
  ...
  warning_votes:
    "投票需要至少1单位TRON Power，TRON Power 可以通过在(账户页面)冻结TRX获得。",
  account_page: "账户页面",
  loading_votes: "投票加载中",
  ...
  */
  ...
  ledger_connected_tronscan_message_0:
    "如您的Ledger已正常连接，波场区块链浏览器将显示“已连接” ",
  click_on_open_wallet: "点击“打开钱包”",
  redirect_to_your_wallet_message:
    "将跳转至您的钱包，可以在钱包查看您的波场地址",
  using_ledger_to_sign_transactions: "使用Ledger对交易进行签名",
  using_ledger_to_sign_transactions_message_0:
    "在使用Ledger和波场区块链浏览器对交易进行签名的过程中，请不要中断Ledger的连接，并保持TRON APP处于开启状态",
  using_ledger_to_sign_transactions_message_1:
    "需要对交易签名时，区块链浏览器会弹出窗口，显示交易信息。在投票、发送TRX、更改账户名称等过程中，都需要进行交易签名。",
  ledger_note: "注意",
  ...
  ledger_note_message_3:
    "支持功能：TRX转账，TRC 10 通证转账，TRC 20 通证转账，冻结TRX，解冻TRX，投票，设置账户名称。",
  ledger_note_message_4:
    "目前不支持的功能：创建通证，交易所交易，申请超级代表，解冻锁仓的通证，领取出块奖励，更新github链接，创建交易对，交易对注资，交易对撤资。",
  ...
  */
  buy_trx: "购买TRX",
  buy_trx_message_0:
    "TRX可以直接使用法定货币或是其它加密货币来购买而不需要通过交易所。这是因为我们使用了来自Changelly.com的服务，这也是最简单最快捷的购买TRX的方法。支持兑换的加密货币种类和常见问题请参见：",
  ...
  */
  ...
  modify_on: "修改日期",
  rating_description:
    "波场区块链浏览器“通证信誉评级系统”旨在帮助用户了解、识别与判断不同通证，当您访问通证页面时，本评级服务将通过以下5种标志显示:",
  rating_status_1: "等待审核",
  rating_status_1_desc_a: "还未经过审核",
  rating_status_2: "OK",
  rating_status_2_desc:
    "一个'OK'信誉评级不是一个认可或推荐，但有以下标准的组合:",
  ...
  rating_status_2_desc_d:
    "该通证在一个具有AML/KYC检查的加密货币交易所交易/上市",
  ...
  rating_status_3_desc_a:
    "提供必要且充分的信息(官方网站、logo、官方联系邮箱、白皮书)",
  rating_status_3_desc_b:
    "项目发起人/投资人/顾问的可见资料(LinkedIn个人简介中也包含了该项目)",
  rating_status_3_desc_c: "提供支持社交媒体资料",
  rating_status_4: "信息不充分",
  rating_status_4_desc_a:
    "未提交必要且充分的信息（官方网站、logo、官方联系邮箱、白皮书）",
  rating_status_4_desc_b: "没有资料显示该项目有持续的运营进展",
  rating_status_5: "信息存在虚假",
  rating_status_5_desc_a: "冒充他人身份与行为发行通证",
  rating_status_5_desc_b:
    "有资料显示，与本通证有关的诈骗/网络钓鱼/诈骗/滥发讯息或虚假陈述的资料并未得到适当处理，或有其他“危险”信号",
  rating_disclaimer: "免责声明",
  disclaimer_desc_1:
    "波场区块链浏览器不支持、不批准或不谴责与波场区块链浏览器上显示的通证相关的任何服务或项目。用户在采取任何与通证相关的行动之前，应始终进行自己的研究和调查，尤其是涉及到价值投资的时候。",
  disclaimer_desc_2:
    "与这项服务有关的信誉评分可能准确，也可能不准确，因为它们是基于主观评价和来自社区的报告。我们毫无保证或承担任何关于内容、准确性和可靠性这样的责任,我们的信誉评级不构成任何行为建议，尤其是投资建议。",
  disclaimer_desc_3:
    "我们保留在本页给通证评定象征性信誉的最终解释权，我们没有义务提供任何关于拒绝的理由的反馈。一旦发现虚假信息或不符之处，我们保留删除或更新信息(包括信誉)的权利。",
  ...
  */
  ...
  not_started: "尚未开始",
  no_token_to_buy:
    "抱歉，所有流通通证已发行完毕，请等待冻结的通证解锁后进行参与。",
  ...
  verify_code3:
    "tronscan完全尊重源代码的作者（或版权所有者）对代码的所有权，我们有道义，道德和法律义务，向提供合约源代码的作者保证，仅在我们提供的服务范围内使用",
  ...
  contract_enery_tip:
    "调用智能合约会消耗一定的能量，这个能量由合约和用户按照此比例承担",
  ...
  */
  ...
  tron_power_freezing:
    "TRON power 可以通过冻结TRX来获得，每冻结1个TRX，可以获得1个TRON power。",
  ...
  contract_notes: "注意事项",
  contract_notes_1:
    "要验证接受构造函数参数的合约，请在下方方框内输入ABI已编码的函数参数。",
  ...
  contract_notes_5:
    "每个合约的编译有最多45秒的等待时间。如果您的合约需要更长时间，我们将无法对其进行验证。",
  ...
  txn: "txn",
  contract_name_tip:
    "必须与源码中的合约名称相匹配，如果是一个多部分的合约，那么它需要与你部署的合约名称相匹配。",
  constructor_arguments_ABIencoded_tip:
    "这个选项只适用于含有构造函数参数的合约，如果你不确定是否含有那么你大概率不需要填这项。",
  ...
  */
  ...
  apply_content:
    "如果您想上币，请填写申请表单提供上币的相关信息，提交信息后，我们将会第一时间进行资料审核。在审核结果回复前，请您耐心等待。",
  ...
  token_application_instructions_1:
    "申请DEX上币需要填写表单，审核通过的TOKEN会上架DEX列表显示。未经过审核的TOKEN，只能搜索后进行交易。",
  ...
  */
  ...
  committee_dec_4:
    "当提议在有效期内获得{total}个代表及以上的赞成票时，该提议获得通过，并在下个维护期内进行网络参数修改。",
  ...
  */
  ...
  what_we_do: "我们在做什么？",
  Transcan_desc:
    "Tronscan是基于波场的第一款区块浏览器。不仅包含区块浏览器的一些基础功能如搜索查询交易、账户、区块、节点、智能合约；链上数据统计和查询，还直接支持token创建。同时Tronscan还有内置web wallet和基于Bancor的DEX，更加丰富了Tronscan的应用矩阵。",
  Our_team: "社区贡献者",
  Team_desc:
    "我们团队是位于马耳他的区块链福利基金会，一直积极参与波场的生态建设中。团队成员30多人，遍布世界各地，多为开发者和运营人员。未来我们会长期绑定波场生态发展，完善Tronscan的同时会致力于开发基于波场的DApp。",
  User_many: "Tronscan用户遍布全球",
  User_many_desc:
    "每天都有来自全球的波场支持者使用tronscan区块浏览器，在这里，他们可以查询交易的详细信息，体验波场最新的功能。",
  HarryXu: "提供许多前端技术支持",
  ...
  */
  ...
  issued_token_of_tronscan:
    "已发行的通证，只有经过tronscan审核后，才会展示到TRC 10通证概览中。",
  ...
  */
  ...
  trc20_footer_standard_5:
    "注：收费标准解释权归Poloni DEX所有，Poloni DEX保留调整费率的权利。",
  ...
  trc20_token_application_instructions_1:
    "为了提供更好的使用体验，申请上币需要填写表单，提供您币种的详细信息，收到资料后，我们将会在3~5个工作日内完成资料审核。不经过审核的代币，将会被隐藏。",
  ...
  trc20_vena_tip:
    "由于 VENA 的智能合约的特殊性，当您卖出 VENA 时，需要对额外的 0.1 VENA 进行授权，但不会进行扣除。",
  ...
  create_deal_pair_input_tip2:
    "交易对创建成功后，上线发行价格无法更改，每次创建需消耗1024 TRX",
  ...
  Create_token_link_message_0:
    "该通证经过Tronscan审核，审核成功方可展示在通证列表中",
  sign_in_TRONlink_warning_0: "请登录TRONlink钱包！",
  account_ad: "TRONdice 玩游戏得dice币，抵押dice币每日得TRX分红",
  bandwidth_tip:
    "在波场，除查询之外的任何交易都需要消耗带宽,系统每天给每个激活账户赠送5000带宽,用户可以通过冻结trx获得带宽。",
  energy_tip:
    "在波场，智能合约的创建和调用都需要消耗能量，用户可以通过冻结trx获得能量。",
  ...
  */
  ...
  table_info_account_tip2:
    "个账户，目前只展示前10,000个（按照TRX余额从大到小排列）。",
  table_info_holders_tip1: "当前通证共有",
  table_info_holders_tip2:
    "个地址，目前只展示前10,000个(按照通证数量从大到小排序)",
  Singapore: "新加坡",
  table_info_new_tip:
    "目前只展示前10,000条数据.如果您想要查询其他数据，建议调整时间范围。",
  ...
  */
  ...
  login_privatekey_warn:
    "为确保您的账户安全，请您妥善保管好私钥，以防资产丢失。建议您使用",
  ...
  token_input_success_tip:
    "录入成功的token可以在列表中找到；wallet和tronlink会自动收录；可以被搜索到",
  token_logo_input_placeholder:
    "请提交图片链接，支持jpg/jpeg/png格式，尺寸比例1:1",
  ...
  interTrx_tip:
    "内部交易是指普通地址调用智能合约，由合约向其它地址转移通证的一种操作",
  event_tip:
    "事件是让程序编写人员或外部界面提供者使用它来注意合约操作动向和审计",
...
*/
  ...
  verify_code1:
    "合约验证是指将您编写好的智能合约代码与发布到区块链网络上的智能合约代码进行匹配，以核对智能合约的真实性及其透明度。",
  verify_code2:
    "您可以通过上传智能合约文件，在TRONSCAN上验证智能合约，对其进行审核。",
  ...
  */
  ...
  contract_deploy_info1:
    "合约部署是指将您编写好的智能合约代码发布到区块链网络。您可以通过上传智能合约文件，在TRONSCAN上编译并部署智能合约。",
  contract_deploy_info2:
    "注意，合约部署会消耗一定数量的TRX，请确保您的账户余额充足。",
  ...
  */
  ...
  voting_brokerage_tip:
    "超级代表所获得的奖励中，分给投票者的比例。投票奖励 = 总奖励数 * 投票分成比例 *（投票票数 / 得票总数）",
  ...
  developers_reward_tip:
    "感谢所有帮助java-tron开发的开发者们，波场基金会欢迎并且感谢所有开发者们的贡献。",
  developers_niTron:
    "2020年，niTron全球开发者大会将于2月29日在韩国举办。 截止到2020年1月31日，总积分排名前五的开发者，每人都可以获赠门票两张。",
  ...
  */
  ...
  signature_privilege_desc:
    "拥有者权限是账户的最高权限，用于控制用户的所有权、调整权限结构拥有者权限也可以执行所有合约",
  ...
  signature_active_permissions_desc:
    "活跃权限用于提供一个权限的组合；比如提供一个只能执行创建账户、转账功能的权限最多添加8个活跃权限",
  ...
  tronscan_not_support_signatures_this_transaction:
    "TRONscan不支持此交易的签名",
  signaure_control_address_tip:
    "控制地址表明了拥有者权限，超级代表权限和活跃权限的所属地址修改控制地址后展示的3类权限也会随之改变",
  "TRX Transfer": "TRX转账",
  "TRX Freeze": "冻结资产",
  "TRX Unfreeze": "解冻资产",
  "Account Create": "激活账户",
  ...
  token_rating_rule_title_p1:
    "未知信用评级是新录入通证的默认评级，若通证发行成功后未补充更新信息，只有强制基本信息的话，将会被认为是未知通证。强制基本信息包括：通证名称、通证简称、通证简介、发行量、精度、发行者，TRC20通证还应包含发行合约、合约创建时间和合约创建者。",
  token_rating_rule_title_p2_title: "中立",
  token_rating_rule_title_p2:
    "此类通证在发行成功后补充更新了信息，具体包括：官网、Logo、邮箱、GitHub地址、白皮书地址、社交媒体链接（至少一个）",
  token_rating_rule_title_p3_title: "OK",
  token_rating_rule_title_p3:
    "若通证在POLONIDEX正式上线交易，则会获得OK信用评级。",
  token_rating_rule_title_p3_1:
    "POLONIDEX上币申请需要在TRONSCAN进行，在申请前需要了解以下事项：  ",
  token_rating_rule_title_p3_2:
    "1）请先登TRONSCAN，并确保该账户至少有一个已经发行的 TRC10 / TRC20 通证。",
  token_rating_rule_title_p3_3:
    "2）选择需要在POLONIDEX上币的通证，提供一些基本信息，该通证便可以通过搜索进行交易。",
  token_rating_rule_title_p3_4:
    "3） 如果您希望通证显示在行情列表中，则需要提供更多信息， 将有专业的审核人员审核您的申请。在通过审核后，POLONIDEX将在一周内通过电子邮件与您联系。只有通过审核的通证才具有获得OK信用评级的资格。",
  token_rating_rule_title_p4_title: "有风险",
  token_rating_rule_title_p4:
    "此类通证有关于欺诈/钓鱼/伪造/发送垃圾信息等的举报，或有关于此类通证的虚假陈述的举报且未有效处理，或有其他恶性报告，经TRONSCAN评估认为存在安全风险。存在安全风险的通证将无法在TRONSCAN上搜索到。  ",
  token_rating_rule_title_p5_title: "欺诈",
  token_rating_rule_title_p5:
    "此类通证有大量关于欺诈/钓鱼/伪造/发送垃圾信息等的举报，或有大量关于此类通证的虚假陈述的举报且未有效处理，或有大量其他恶性报告，或项目团队解散、官方网站和社区长时间无人维护，或项目团队涉嫌违法行为面临重大法律制裁，经TRONSCAN评估认为存在极高安全风险。存在极高安全风险的通证将无法在TRONSCAN上搜索到。",
  token_rating_rule_title_end_title: "免责声明：",
  token_rating_rule_title_end_1:
    "TRONSCAN作为波场生态的一款区块浏览器，仅提供波场生态数据信息的展示和查询等服务，关于通证的所有信息皆由通证所有者自行上传，TRONSCAN不参与任何通证的发行和发展，不对通证信息的真实性和有效性做任何担保，请注意甄别使用。",
  token_rating_rule_title_end_2:
    "信用评级仅是基于通证信息的完善度和社区反馈来评定的，旨在为用户提供一定的参考，并不是通证的绝对价值判断，可能会与通证的真实情况有所偏差。TRONSCAN不对此信用评级的准确性和可靠性做任何保证，也不对由此造成或声称由此造成的损失承担任何直接或间接的责任。",
  token_rating_rule_title_end_3:
