export const messages = {
  ...
  */
  ...
  "continue_enter": "继续录入",
  "token_markets_input": "录入 TRXMarket",
  ...
  */
  ...
  "trc20_footer_standard_5": "注：收费标准解释权归TRXMarket所有，TRXMarket保留调整费率的权利。",
...
*/
  ...
  */
  ...
  "signature_privilege":"Owner privilege",
  "signature_privilege_desc":"Owner privilege is the highest privilege of the account. It is used to control the ownership of the user and adjust the permission structure. Owner privilege can also execute all contracts",
  "signature_permission":"Permission to name",
  "signature_threshold":"Threshold value",
  "signature_keys":"keys",
  "signature_key":"key",
  "signature_weight":"weight",
  "signature_active_permissions":"Active permissions",
  "signature_active_permissions_desc":"Active permissions are used to provide a combination of permissions. For example, provide a permission that can only be performed to create accounts and transfer money Add up to eight active permissions  ",
  "signature_Operations":"Operations",
  "signature_Superdelegate_authority":"Superdelegate authority",
  "signature_Superdelegate_authority_desc":"Superdelegate privileges are used to set block nodes",
  "signature_piece_node":"A piece of the node",
  "signature_no_set":"此地址为合约地址,不能设置",
  "signature_Unverified_address":"Unverified address",
  "signature_notInContralAddress":"your address is not in control address keys",
  "signature_invalid_Address":"无效地址",
