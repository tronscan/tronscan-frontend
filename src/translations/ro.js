export const messages = {
    ...
    */
    ...
    "website": "site web",
    "address": "adresă",
    "sign_out": "ieșire din cont",
    "sign_in": "intrare în cont",
    "register_login": "înregistrare / Logare",
    ...
    "supply": "supply",
    "view": "vizionare",
    "view_all": "vizionare tot",
    "create": "crează",
    "country": "regiune",
    "amount": "cantitate",
    "my_vote": "votul meu",
    "submit_votes": "propune voturi",
    "accounts": "conturi",
    "created": "creat",
    "exchange": "Exchange",
    "next": "următorul",
    "copied_to_clipboard": "copiat pe clipboard",
    "cancel": "Anulare",
    "reset": "Resetare",
    "error": "Eroare",
    "unlock_keyFile": "deschide KeyFile",
    "enter_password_message": "Trebuie să introduceți parola!",
    "password_incorrect": "Parolă incorectă",
    "try_again": "Încercați din nou",
    "wallet_unlocked": "Portofel descuiat",
    "weak": "slab",
    "okay": "în regulă",
    "good": "bun",
    "strong": "puternic",
    ...
    */
    ...
    "markets": "Piețe",
    "tools": "Unelte",
    "transaction_viewer": "Vizualizator Tranzacție",
    "node_tester": "Tester Nod",
    "system": "Sistem",
    "news": "Știri",
    "help": "Ajutor",
    "nodes": "Noduri",
    ...
    */
    ...
    "first_node_sync_message": "Se așteaptă sincronizarea primului nod, vă rugăm încercați din nou în câteva minute",
    "last_block": "Ultimul Block",
    "blocks_produced": "Blocuri Produse",
    "blocks_missed": "Blocuri Ratate",
    "productivity": "productivitate",
    "rewards": "recompense",
    "token_created": "creare Token",
    "witness": "Martor",
    ...
    */
    ...
    ##################################################################################
    */
    "set_name": "Setare Nume",
    "unique_account_message": "Puteți să setați numele de cont doar o dată!",
    "name_to_short": "Nume prea scurt",
    "name_to_long": "Nume prea lung",
    "permitted_characters_message": "Numele poate să conțină numai a-z A-Z 0-9",
    ...
    "voters": "votanți",
    "progress": "progres",
    "transactions_count": "{tranzacții, plural, una {tranzacție} alte {tranzacții}}",
    "issuer": "emitent",
    "network": "rețea",
    "current": "curent",
   ...
   După această perioadă puteți să dezghețați TRX și să tranzacționați tokeni.`,
    ...
    "tokens_unfrozen": "Tokeni dezghețați",
    "success_tokens_unfrozen_message": "tokeni dezghețați cu succes",
    "unable_to_unfreeze": "Nu se poate dezgheța",
    "Unable_tokens_unfrozen_message": "Nu se pot dezgheța tokenii.",
    "tokens_frozen": "Tokeni Înghețați",
    "successfully_frozen": "Înghețare cu succes",
    "name_changed": "Nume schimbat",
   ...
   TRX-ul nu va fi consumat în procesul de aplicare și votare de super delegat.`,
    ...
    "create_account_confirm_3": "Mi-am notat parola pe hârtie",
    ...
    ##################################################################################
    */
    "name_of_the_token": "Numele tokenului",
    "token_message": "Nume pentru token",
    "token_abbr": "Abreviere pentru token",
    "abbr_message": "Abreviere pentru token",
    "total_supply": "supply total",
    "issued_token": "token emis",
    "create_token": "Creați Token",
    "description": "Descriere",
    "description_url": "Descriere URL",
    "quote_token_amount": "Cotă cantitate token",
    "base_token_amount": "Cantitate de Bază Token",
    "creating_a_token": "Creare token",
    ...
    "participated": "Ați participat cu succes!",
    "participated_error": "A apărut o eroare",
    /*
    ##################################################################################
    #                                                                                #
    # token participate                                                              #
    ...
    ##################################################################################
    */
    "buy_confirm_message_0": "Sunteți sigur?",
   ...
   Voturile finale vor fi numărate la ora 24 şi va fi actualizată lista delegatilor.`,
    ...
    "token_holders": "Deținători Tokeni",
    "nr_of_Transfers": "Număr de Transferuri",
    "not_signed_in": "trebuie să vă autentificaţi pentru a face uz de această funcţionalitate",
    "loading_map": "Încărcare hartă",
    "loading_accounts": "Încărcare conturi",
    "quantity": "cantitate",
    "percentage": "Procentaj",
    "loading_token": "Încărcare Token",
    "voter_percentage": "Procentaj Votanți",
    /*
    ##################################################################################
    #                                                                                #
    ...
    ##################################################################################
    */
    "no_transactions_found": "Nici o tranzactie găsită",
    "no_tokens_found": "Nici un token găsit",
    "no_blocks_found": "Nici un block găsit",
    "no_votes_found": "Nici un vot găsit",
    "no_voters_found": "Nici un votant găsit",
    "waiting_for_transactions": "În aşteptare pentru tranzacţii",
    "loading_address": "Încărcare Adresă",
    /*
    ##################################################################################
    #                                                                                #
    ...
    */
    "details": "detalii",
    "issue_a_token": "Emiteți un Token",
    "issue_token": "Emitere Token",
    "token_name": "nume toke",
    "total_issued": "Total emis",
    "registered": "Înregistrat",
    "abbreviation": "Abrevieri",
    "exchange_rate": "Rată de schimb",
   ...
   zilele de înghețare care s-au scurs. Înghețarea de supply nu este necesară.`,
    "token_issued_successfully": "Token emis cu succes",
    ...
    ##################################################################################
    */
    "date_error": "data de sfârşit este mai devreme, sau la fel ca data de început",
    ...
    "no_url_error": "URL-ul Web este necesar",
    "past_starttime_error": "Data de început este în trecut",
    "no_transactions": "Fără tranzacţii",
    "errors_in_form": "Există erori în formular",
    "token_link_message_0": "Token-ul va fi disponibil pe",
    "token_link_message_1": "Pagina token",
    "token_link_message_2": "în câteva minute",
    "description_error_message_0": "Descrierea nu poate fi mai lungă de 200 de caractere",
    "token_creation_error": "A apărut o eroare în timp ce se încerca crearea tokenului",
    "tokenname_error_message_0": "Numele nu poate fi mai lung de 32 de caractere",
    "tokenname_error_message_1": "Numele poate conține numai caractere a-Z",
    "abbreviation_required": "Abrevierea este necesară",
    "abbreviation_error_message_0": "Abrevierea nu poate fi mai lungă de 5 caractere",
    "abbreviation_error_message_1": "Abrevierea poate conține numai caractere a-Z ",
    /*
    ##################################################################################
    #                                                                                #
    ...
    */
    ...
    ##################################################################################
    */
    "average_price_usd": "Preț mediu în USD",
    "average_volume_usd": "Volum mediu în USD",
    "Trade Volume": "Volum Tranzacționare",
    "rank": "rang",
    "pair": "pereche",
    "volume": "Volum",
    "usd": "USD",
    ...
    */
    ...
    "live_ranking": "Rang Live",
    "live_ranking_msg": "Refresh la fiecare 15 secunde. Noile voturi ar dura până la 1-2 minute până sunt numărate",
    "candidate": "Candidat",
    "current_votes": "Voturi Curente",
    "click_to_start_voting": "Clic aici pentru a începe votul",
    ...
    ##################################################################################
    */
    "info_tx_viewer": "Aici puteți să faceți paste la un hex de tranzacție pentru a inspecta conținutul tranzacției. Tranzacția poate fi apoi transmisă pe rețea",
    "load_tx": "Încărcare Tranzacție",
    "tx_qrcode": "Tranzacție Cod QR",
    "load_tx_qrcode": "Încărcare tranzacție de la Cod QR ",
    "transaction_load_error": "Eroare încărcare tranzacție",
    "transaction_load_error_message": "Ceva nu a mers bine în timp ce se încărca tranzacția. Asigurați-vă că HEX este în formatul corect.",
    "transaction_success_message": "Tranzacție transmisă cu succes rețelei.",
    "transaction_success": "Tranzacție efectuată cu succes",
    "transaction_error_message": "Ceva nu a mers bine în timp ce se încerca transmiterea tranzacției.",
    "transaction_error": "Eroare tranzacție",
    "confirm_transaction_message": "Sunteți sigur că vreți să trimiteți tranzacția?",
    "broadcast_transaction_to_network": "Emitere Tranzacție pe Rețea",
    /*
    ##################################################################################
    #                                                                                #
    # tools node tester                                                              #
    ...
    ##################################################################################
    */
    "node_tester_msg": "Inserați IP-ul nodului dumneavostră pentru a testa conexiunea GRPC",
    "node_tester_stop": "Stop testare",
    "node_tester_test": "Testare GRPC",
    ...
    ##################################################################################
    */
    "no_webcam_found": "Nu a fost găsită cameră web",
    "trying_enable_webcam_message_0": "Eroare în timp ce se încerca pornirea camerei web.",
    "trying_enable_webcam_message_1": "Asigurați-vă că permisiunile de cameră sunt pornite.",
    /*
    ##################################################################################
    #                                                                                #
    # help section                                                                   #
   ...
   "open_wallet": "Sign in",
    ...
    "keystore_file": "Fișier Keystore",
    "select_file": "Selectează Fișier",
    "login_mobile": "Logați-vă cu un dispozitiv mobil",
    "create_wallet": "creați portofel",
    "no_open_wallet": "Nici un portofel deschis pentru vizualizare",
    "new_wallet": "Portofel Nou",
    "password_encr_key_message_0": "Această parolă criptează cheia privată. Aceasta nu acționează ca o sămânță pentru a genera chei.",
    "password_encr_key_message_1": "Aveți nevoie de această parolă și cheia privată pentru a vă deschide portofelul.",
    "strong_password_info": "Se necesită o parolă puternică",
    ...
    "make_a_backup_message_0": "În cazul în care laptopul ia foc.",
    "save_private_key": "Salvați-vă Cheia Privată",
    ...
    */
    ...
    "avg_blockTime": "Timp Mediu Bloc",
    "avg_blockSize": "Mărime medie Bloc",
    ...
    "participate_token_between_addresses": "Participare token între adrese",
    "witness_update_contract": "Updatare Contract Witness",
    ...
    "issue_a_new_asset": "Emitere de Bun Nou",
    "owner_address": "Adresă Deținător",
    ...
    "contracts": "Contracte",
    "search_description": "Caută Adresă,Înălțime Bloc,Hash Tranzacție,Nume Token",
    "search_description1": "Caută Adresă,Bloc,Tranzacție,Token",
    "transaction": "Tranzacție",
    "total_addresses": "Total Adrese",
    "daily_increment": "Creștere zilnică",
