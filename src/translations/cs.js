export const messages = {
    ...
    */
    ...
    "sign_out": "odhlásit",
    "sign_in": "pøihlásit",
    "register_login": "Registrovat / Pøihlásit",
    ...
    "to": "do",
    "value": "hodnota",
    "total_accounts": "Všechny úèty",
    "submit": "Potvrdit",
    "send": "odeslat",
    "receive": "pøijmout",
    "supply": "množství v obìhu",
    "view": "zobrazit",
    ...
    */
    ...
    "markets": "Trhy",
    "tools": "Nástroje",
    "transaction_viewer": "Prohlížeè transakcí",
    ...
    */
    ...
    "first_node_sync_message": "Èekám na synchronizaci prvního nódu, prosím, zkus to znovu za nìkolik minut.",
    "last_block": "poslední blok",
    "blocks_produced": "Vytvoøených blokù",
   ...
   Po uplynutí této doby mùžete TRX rozmrazit a opìt s nimi obchodovat.`,
    ...
    "success_tokens_unfrozen_message": "Úspìšnì rozmrazené tokeny",
    ...
    "successfully_frozen": "Úspìšnì zmrazeno",
    "name_changed": "Název zmìnìn",
    ...
    */
    ...
    "total_supply": "celkové množství v obìhu",
    "issued_token": "vydané tokeny",
    "create_token": "Vytvoøit token",
    "description": "Popis",
    "description_url": "Popis URL",
    "quote_token_amount": "Nabídnout množství tokenù",
    "base_token_amount": "Základní množství tokenù",
    "creating_a_token": "Vytváøím token",
    "available": "dostupný",
   ...
   Finální hlasy budou seèteny ve 24:00 a poté bude aktualizován seznam delegátù.`,
    ...
    "token_holders": "Držitelé  tokenù",
    "nr_of_Transfers": "Poèet transferù",
    "not_signed_in": "Pokud chcete použít tuto funkci, musíte být pøihlášeni",
    "loading_map": "Naèítám mapu",
    "loading_accounts": "naèítám Úèty",
    "quantity": "množství",
    "percentage": "Procento",
    ...
    */
    ...
    "live_ranking": "Live poøadí",
    "live_ranking_msg": "Obnova každých 15 sekund. Než se zapoèítají nové hlasy, mùže to trvat 1-2 minuty",
    "candidate": "Kandidát",
    "current_votes": "Aktuální poèet hlasù",
    ...
    */
    ...
    "transaction_load_error": "Chyba pøi naèítání transakce",
    "transaction_load_error_message": "Pøi naèítání transakce došlo k chybì. Zkontrolujte, jestli je HEX ve správném formátu",
    "transaction_success_message": "Transakce úspìšnì odeslána do sítì",
    "transaction_success": "Transakce úspìšná",
    "transaction_error_message": "Pøi odesílání transakce do sítì došlo k chybì",
   ...
   "open_wallet": "Sign in",
    ...
    "login_mobile": "Pøihlásit se pomocí mobilního zaøízení",
    "create_wallet": "vytvoøit penìženku",
    "no_open_wallet": "Žádná otevøená penìženka k zobrazení",
    "new_wallet": "Nová penìženka",
    "password_encr_key_message_0": "Toto heslo šifruje váš soukromý klíè. Nefunguje jako seed k vygenerování vašich soukromých klíèù.",
    "password_encr_key_message_1": "K odemèení penìženky budete potøebovat heslo a soukromý klíè.",
    ...
    "make_a_backup_message_0": "Pro pøípad kdyby váš notebook shoøel.",
    "save_private_key": "Uložte si soukromý klíè",
