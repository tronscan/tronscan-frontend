export const messages = {
    ...
    #         Number of checks: 4                                                    #
    #         Participants: Wistan Sound, Adam Žurek                                 #
    #                                                                                #
    ##################################################################################
    #                                                                                #
    ...
    */
    ...
    "sign_out": "odhlásit",
    "sign_in": "přihlásit",
    "register_login": "Registrovat / Přihlásit",
    ...
    "bytes": "Bytů",
    "MByte": "MByte",
    "produced_by": "vytvořil",
    "block_reward": "Block Reward",
    "contract": "smlouva",
    "from": "z",
    "to": "do",
    "value": "hodnota",
    "total_accounts": "Všechny účty",
    "submit": "Potvrdit",
    "send": "odeslat",
    "receive": "přijmout",
    "supply": "množství v oběhu",
    "view": "zobrazit",
    "view_all": "Zobrazit vše",
    "create": "vytvořit",
    "country": "země",
    "amount": "množství",
    "my_vote": "moje hlasování",
    "submit_votes": "odeslat hlas",
    "accounts": "účty",
    "created": "vytvořeno",
    "exchange": "Burza",
    "next": "další",
    ...
    "wallet_unlocked": "Peněženka odemčena",
    "weak": "slabé",
    "okay": "ok",
    "good": "dobré",
    "strong": "silné",
    ...
    */
    ...
    "markets": "Trhy",
    "tools": "Nástroje",
    "transaction_viewer": "Prohlížeč transakcí",
    ...
    */
    ...
    "most_nodes": "většina nódů",
    "loading_nodes": "načítám nódy",
    "Hostname": "Hostname",
    "Last Update": "Poslední update",
    "first_node_sync_message": "čekám na synchronizaci prvního nódu, prosím, zkus to znovu za několik minut.",
    "last_block": "poslední blok",
    "blocks_produced": "Vytvořených bloků",
    "blocks_missed": "Chybějící bloky",
    "productivity": "produktivita",
    "rewards": "odměna",
    "token_created": "Token vytvořen",
    "witness": "Witness",
    "asset_participation": "Zastoupená aktiva",
    "loading_transaction": "Načítám transakci",
    ...
    */
    ...
    "average_blocksize": "Průměrná velikost bloku",
    ...
    */
    ...
    "unique_account_message": "Název účtu můžete nastavit jen jednou!",
    "name_to_short": "Název je moc krátký",
    "name_to_long": "Název je moc dlouhý",
    "permitted_characters_message": "Název může obsahovat pouze a-z A-Z 0-9",
    "change_name": "Změna názvu",
    "account_name": "Název účtu",
    "show_qr_code": "Zobrazit QR kód",
    "do_not_send_2": "Neposílejte TRX ze své peněženky nebo z burzy na výše uvedenou adresu účtu na testovací síti!",
    ...
    "free_bandwidth": "šířka pásma zdarma",
    "expires": "vyprší",
    "have_been_added_to_your_account": "bylo připsáno na váš účet!",
    "information_message_1": "Po vyžádání TRX obdržíte 10000 TRX, které můžete použít k testování na testovací síti.",
    "information_message_2": "Vyžádat si TRX je možné pouze 10x pro jeden účet.",
    "request_trx_for_testing": "Vyžádat si TRX na testování",
    "token_balances": "zůstatky tokenů",
    "produced_blocks": "vytvořené bloky",
    "voters": "voliči",
    "progress": "průběh",
    "transactions_count": "{transakce, plural, one {transakce} other {transakcí}}",
    "issuer": "vydavatel",
    "network": "síť",
    "current": "aktuální",
    "trx_received": "obdrženo TRX",
    "test_trx_temporarily_unavailable_message": "Testování TRX je dočasně nedostupné. Prosím, zkus to později.",
    "not_enough_trx": "Málo TRX",
    "information_message_3": "TRX úspěšně vyžádáno. Pokud jste neobdrželi žádné TRX, není v současné době k dispozici žádný TRX k testování a měli byste to zkusit později.",
    "send_to_following_address": "Poslat na následující adresu",
    "change_website": "Změnit webovou stránku",
    "you_must_enter_url": "Musíte zadat URL",
    "specify_the_url": "Prosím, upřesněte URL",
    /*
    ##################################################################################
    #                                                                                #
    # account freeze                                                                 #
    ...
    */
    "freeze": "zmrazit",
    "unfreeze": "rozmrazit",
    "freeze_trx_least": "Ke zmrazení je nutné mít na účtu minimálně 1 TRX",
    "unable_unfreeze_trx_message": "Rozmrazení TRX nemožné. To může být způsobeno tím, že ještě neuběhla požadovaná doba od posledního zmrazení.",
    "freeze_trx_premessage_0": `TRX můžete zmrazit za účelem získání TRON Power a uvolnění dalších funkcí.
  For example, with TRON Power you can `,
    "freeze_trx_premessage_link": "hlasovat pro Super Reprezentanty.",
    "freeze_trx_premessage_1": ` Zmrazené tokeny jsou "zamčené" na dobu 3 dnů. Během této doby není možné se zmrazenými TRX obchodovat.
  Po uplynutí této doby můžete TRX rozmrazit a opět s nimi obchodovat.`,
    "trx_amount": "Množství TRX",
    "token_freeze_confirm_message_0": "Potvrzuji zmrazení ",
    "token_freeze_confirm_message_1": "minimálně na 3 dny",
    "frozen_supply": "Zmrazené tokeny",
    "tokens_unfrozen": "Rozmrazené tokeny",
    "success_tokens_unfrozen_message": "Úspěšně rozmrazené tokeny",
    "unable_to_unfreeze": "Unable to unfreeze",
    "Unable_tokens_unfrozen_message": "Rozmrazit tokeny nebylo možné.",
    "tokens_frozen": "Tokens Frozen",
    "successfully_frozen": "Úspěšně zmrazeno",
    "name_changed": "Název změněn",
    "successfully_changed_name_to_message": "Název úspěšně změněn na",
    "unable_to_rename_title": "Nemožné přejmenovat",
    "unable_to_rename_message": "Během změny názvu účtu došlo k neočekávané chybě, prosím zkuste to později znovu",
    "unfreeze_trx_confirm_message": "Opravdu chcete rozmrazit TRX?",
    "unfreeze_assets": "Rozmrazit tokeny",
    "sure_to_unfreeze_unlocked_tokens_message": "Určitě chcete rozmrazit odemčené tokeny?",
    /*
    ##################################################################################
    #                                                                                #
    ...
    */
    ...
    "apply_for_delegate_predescription": `Každý držitel tokenů má možnost stát se TRON Super Reprezentantem.
  Aby však síť a komunita fungovala efektivně a bez problémů,
  vytvořili jsme pro kandidáty, kteří se chtějí stát doporučeným Super reprezentantem, sadu standardů a regulací. Doporučované SR budeme propagovat, abychom zvýšili jejich šance na zvolení. Noví doporučení Super Reprezentanti jsou aktualizováni a zveřejòováni jednou týdně.`,
    "apply_for_delegate_description": `
  Pokud se držitelé TRX chtějí stát super delegátem, mohou si podat žádost prostřednictvím funkce správy účtu a hlasovat pro kandidáty.
  Každý účet může aktualizovat aktuální informace o voliči a také může hlasovat pro několik kandidátů.
  Maximální počet hlasů je menší nebo roven počtu TRX, které uživatelé mají v držení.
  (Pokud máte určité množství TRX, můžete odeslat pouze tolik hlasů, jejichž počet je menší nebo roven tomuto množství TRX).
  Výsledek hlasování bude vypočítán na základě konečných informací o účtu každého voliče v každém hlasovacím cyklu, který se počítá vždy od 0:00 do 24:00. Držitelé TRX s největším počtem hlasů se stanou super delegáty.
  Každá transakce v rámci sítě je validována všemi Super Delegáty, za což dostávají příslušnou odměnu.
  Během procesu podávání žádostí a hlasování pro super delegáty nebude utracen žádný TRX.`,
    "unknown_error": "došlo k neznámé chybě",
    "representative_understand": "Rozumím tomu, jak se stát TRON reprezentantem",
    "generate_account": "Klikni pro vygenerování adresy účtu a hesla",
    "create_account_confirm_1": "Beru na vědomí, že pokud zapomenu své heslo, ztratím přístup ke svým tokenům",
    "create_account_confirm_2": "Beru na vědomí, že pokud zapomenu své heslo, není nikdo, kdo by mi pomohl mé heslo obnovit",
    "create_account_confirm_3": "Zapsal jsem si heslo na papír",
    "vote_thanks": "Díky za odeslání hlasu!",
    "recent_transactions": "nedávné transakce",
    "newest_account": "nejnovější účet",
    "representatives": "reprezentanti",
    "most_votes": "většina hlasů",
    "start_end_time": "Začátek / Konec",
    "scan_qr_code": "Načti kód pomocí QR čtečky",
    "receive_trx": "obdržet TRX",
    "require_account_to_send": "Na odeslání mincí musíte být přihlášeni",
    "require_account_to_receive": "Na příjem mincí musíte být přihlášeni",
    "successful_send": "Úspěšně odesláno!",
    "confirm_transaction": "potvrdit transakci",
    "last_confirmed": "Poslední potvrzená",
    "trx_produced": "Vytvořeno transakcí",
    "do_not_send_1": "Neposílejte TRX ze své peněženky ani z burzy na vaši adresu na testovací síti!",
    "go_to_votelist": "Přejít na hlasovací seznam",
    ...
    "apply_representative_error_message_0": "Při podání přihlášky na reprezentanta došlo k neznámé chybě.",
    "apply_representative_error_message_1": "Zkontrolujte, zda máte dostatek TRX na poplatek, v opačném případě to zkuste později.",
    "open_external_link": "Sppouštíte externí odkaz",
    "private_key_untrusted_website_message_0": "Nikdy nevkládejte soukromý klíč na nedůvěryhodném webu.",
    "no_official_tron_website": "není oficiální TRON web.",
    "continue_to_external_website": "Pokračovat na externí web",
    "url_changed": "URL změněna",
    "successfully_changed_website_message": "Webová stránka úspěšně změněna na ",
    "unable_to_change_website_title": "Změna URL není možná",
    "unable_to_change_website_message": "Při aktualizci webové stránky došlo k neznámé chybě. Zkuste to prosím později.",
    "successfully_linked_github": "Úspěšně propojeno s Github!",
    ...
    "success": "Úspěch",
    "successfully_appied_sr_canidate_message_0": "Přihláška kandidáta na Super reprezentanta úspěšně podána.",
    "successfully_appied_sr_canidate_message_1": "Váš účet bude zanedlouho upgradován.",
    "landing_page": "Domovská stránka",
    "show_more_information_publish_sr_page": "Zobrazit více informací jak publikovat stránku",
    "create_sr_landing_page_message_0": "Super Reprezentanti si mohou vytvořit domovskou stránku, na které mohou zveřejnit více informací o svém týmu a plánech",
    "set_github_url_message_0": "Nakonfiguroval jste už svou Github šablonu? Pak tedy nastavte svou URL pomocí tlačítka níže",
    "set_github_link": "Nastavit Github odkaz",
    "could_not_claim_rewards": "Nebylo možné vyžádat si odměny",
    "claim_rewards_error_message": "Při vyžádání odměn došlo k neznámé chybě. Prosím, zkuste to později.",
    "rewards_claimed": "Odměny vyžádány!",
    "successfully_claimed_rewards": "Odměny úspěšně vyžádány",
    "claim_rewards": "Vyžádat si odměny",
    "sr_receive_reward_message_0": "Jako reprezentantovi vám náleží odměna za generování bloků. O tuto odměnu můžete žádat každých 24 hodin",
    "intro": "Intro",
    ...
    */
    ...
    "abbr_message": "Zkratka tokenu",
    "total_supply": "celkové množství v oběhu",
    "issued_token": "vydané tokeny",
    "create_token": "Vytvořit token",
    "description": "Popis",
    "description_url": "Popis URL",
    "quote_token_amount": "Nabídnout množství tokenů",
    "base_token_amount": "Základní množství tokenů",
    "creating_a_token": "Vytvářím token",
    "available": "dostupný",
    "testnet": "Testovací síť",
    "days_to_freeze": "Dnů ke zmrazení",
    "trx_token_fee_message": "K vydání nového tokenu je potřeba 1024 TRX.",
    "trx_token_account_limit": "Můžete vytvořit pouze jeden token pod jedním účtem",
    "trx_token_wallet_requirement": "Musíte otevřít peněženku, abyste mohli vytvořit token",
    "invalid_address": "neplatná adresa",
    "insufficient_tokens": "Nedostatečné množství tokenů",
    "fill_a_valid_number": "Prosím vyplòte platné číslo",
    "fill_a_valid_address": "Prosím vyplòte platnou adresu",
    "make_another_transaction": "Provést další transakci",
    "token_exchange_confirm": "Potvrzuji, že na distribuci tokenů vydám {trxAmount}, a dostanu za to celkem {tokenAmount} tokenů.",
    "An_unknown_error_occurred,_please_try_again_in_a_few_minutes": "Došlo k neznámé chybě, prosím zkuste to za několik minut znovu",
    "An_error_occurred": "Došlo k chybě",
    "create_a_token": "Vytvořit token",
    "not_started_yet": "Ještě nezačal",
    "participated": "Úspěšně jste se zúčastnil!",
    "participated_error": "Došlo k chybě",
    /*
    ##################################################################################
    #                                                                                #
    # token participate                                                              #
    ...
    */
    ...
    "how_much_buy_message": "Kolik tokenů chcete nakoupit?",
    "buy_confirm_message_1": "Určitě chcete koupit",
    "for": "za",
    "insufficient_trx": "Nedostatečné množství TRX",
    "not_enough_trx_message": "Na nákup tolika tokenů nemáte dostatečné množství TRX",
    "ends": "končí",
    "starts": "začíná",
    ...
    ##################################################################################
    */
    "address_warning": "Zadejte platnou adresu TRON peněženky. Vložení neplatné adresy povede ke ztrátě TRX.",
    "search_address_or_url": "Vyhledat adresu nebo URL",
    "the_lunch_test": "Spuštěním testovací sítě chceme otestovat všechny funkce prohlížeče blockchainu i peněženky.",
    "please_keep_in_mind": "Nezapomeòte, že vaše registrovaná adresa účtu se používá pouze pro testovací síť, neposílejte tedy TRX ze své peněženky nebo z burzy na adresu na testovací síti.",
    "tron_foundation": "Nadace TRON",
    "trx_for_testing": "TRX určené k testování budou odeslány na váš testovací účet, jakmile si o to ze svého účtu zažádáte.",
    "dear_users": "Milí uživaatelé,",
    "finished": "Ukončeno",
    "token": "token",
    "url": "url",
    "need_to_login": "Na stránku účtu se dostanete až po přihlášení",
    "thanks_for_applying": "Děkujeme za podání žádosti!",
    "to_much_votes": "Příliš mnoho hlasů",
  ...
  Za každý TRX na svém účtě máte jeden použitelný hlas.
  TRX nebudou utraceny. Pro několik reprezentantů můžete hlasovat tolikrát, kolikrát budete chtít.
  Finální hlasy budou sečteny ve 24:00 a poté bude aktualizován seznam delegátů.`,
    "search_address": "Vyhledat adresu",
    "token_transactions": "Transakce tokenů",
    "token_holders": "Držitelé  tokenů",
    "nr_of_Transfers": "Počet transferů",
    "not_signed_in": "Pokud chcete použít tuto funkci, musíte být přihlášeni",
    "loading_map": "Načítám mapu",
    "loading_accounts": "načítám Účty",
    "quantity": "množství",
    "percentage": "Procento",
    "loading_token": "Načítám token",
    ...
    */
    ...
    "no_votes_found": "Nenalezeny žádné hlasy",
    "no_voters_found": "Nenalezeny žádní voliči",
    "waiting_for_transactions": "čekám na transakci",
    "loading_address": "Načítám adresu",
    /*
    ##################################################################################
    #                                                                                #
    ...
    */
    ...
    "total_issued": "Celkem vydáno",
    "registered": "Registrován",
    "abbreviation": "Zkratky",
    "exchange_rate": "Měnový kurz",
    "token_price": "Cena tokenu",
    "supply_message": "Celkové množství tokenů v oběhu",
    "description_message": "Krátký popis účelu tokenů",
    "url_message": "Webová stránka, kde uživatelé mohou najít informace o tokenu",
    "exchange_rate_message_0": "Specifikujte cenu jednoho tokenu určením počtu tokenů, které uživatel obdrží za 1 TRX.",
    "exchange_rate_message_1": "Uživatel obdrží",
    "exchange_rate_message_2": "za každých",
    "exchange_rate_message_3": "TRX",
    "participation_message_0": "Specifikujte období, ve kterém budou tokeny vydány. Během tohoto období uživatelé mohou směòovat TRX za ",
    "participation_message_1": " tokeny.",
    "frozen_supply_message_0": `část mincí v oběhu je možné zmrazit. Určíte specifické množství mincí a ty poté minimálně na 1 den zmrazíte. Zmrazené tokeny mohou být rozmrazeny manuálně po počátečním datu a poté, co bude dosažen počet dní zmrazení. Zmmrazení všech tokenů není požadováno.`,
    "token_issued_successfully": "Token úspěšně vydán",
    "participation": "účast",
    "start_date": "Počáteční datum",
    "end_date": "Koncové datum",
    "token_spend_confirm": "Beru na vědomí, že za celkové množství vydaných tokenů bude účtován jednorázový poplatek 1024 TRX.",
    "token_issue_guide_message_1": `Token na TRON protokolu může vydat každý, kdo má na účtu alespoò 1024 TRX.`,
    "token_issue_guide_message_2": `Jakmile je token vydán, zobrazí se na stránce s přehledem tokenů.
  Uživatelé si následně během daného odobí mohou vyměnit své TRX za tokeny.`,
    "token_issue_guide_message_3": `Po vydání tokenů obdržíte na svůj účet tokeny v hodnotě odpovídající celkovému množství v oběhu.
  Když ostatní uživatelé vymění své TRX za vámi vydaný token, budou tokeny odepsány z vašeho účtu a vy obdržíte TRX v hodnotě odpovídající aktuálnímu kursu.`,
    /*
    ##################################################################################
    #                                                                                #
    ...
    ##################################################################################
    */
    "date_error": "Koncové datum je dřívější nebo stejné jako počáteční datum",
    "no_name_error": "Požadován název",
    "no_supply_error": "Celkové množství musí být minimálně 1",
    "coin_value_error": "Množství tokenů musí být minimálně 1",
    "tron_value_error": "Množství TRX za jednu minci musí být minimálně 1",
    "invalid_starttime_error": "Zadané počáteční datum je neplatné",
    ...
    "past_starttime_error": "Počáteční datum je v minulosti",
    "no_transactions": "Žádné transakce",
    "errors_in_form": "Ve formuláři jsou chyby",
    "token_link_message_0": "Token bude dostupný na",
    "token_link_message_1": "stránce s tokeny",
    "token_link_message_2": "během pár minut",
    "description_error_message_0": "Popis nesmí být delší než 200 znaků",
    "token_creation_error": "Při vytvoření tokenu došlo k chybě",
    "tokenname_error_message_0": "Název nesmí být delší než 32 znaků",
    "tokenname_error_message_1": "Název může obsahovat pouze znaky a-Z",
    "abbreviation_required": "Zadat zkratku je povinné",
    "abbreviation_error_message_0": "Zkratka nesmí být delší než 5 znaků",
    "abbreviation_error_message_1": "Zkraatka může obsahovat pouze znaky a-Z",
    /*
    ##################################################################################
    #                                                                                #
    ...
    */
    ...
    "loading_representatives": "Načítám Reprezentanty",
    "address_not_super_representative": "Tato adresa nepatří Super Reprezentantovi",
    "unable_load_representatives_page_message": "Nemohu načíst stránku, to se může stát, pokud je adresa neplatná, nebo nepatří reprezentantovi, nebo si reprezentant tuto stránku ještě nenakonfiguroval",
    "loading_representative": "Načítám reprezentanta",
    /*
    ##################################################################################
    #                                                                                #
    # markets section                                                                #
    ...
    ##################################################################################
    */
    "average_price_usd": "Průměrná cena v USD",
    "average_volume_usd": "Průměrný objem v USD",
    "Trade Volume": "Objem obchodů",
    "rank": "pořadí",
    "pair": "pár",
    "volume": "Objem",
    "usd": "USD",
    ...
    */
    ...
    "most_ranks": "Nejvyšší příčka získaná v tomto kole",
    "view_live_ranking": "Zobrazit live pořadí",
    "open_team_page": "Otevřít stránku týmmu",
    "warning_votes": "K zahájení hlasování je zapotřebí minimálně 1 TRON Power. TRON Power získáte zmrazením TRX na",
    "account_page": "Účet",
    "loading_votes": "Načítám hlasy",
    "3_day_ranking": "Pořadí za 3 dny",
    "live_ranking": "Live pořadí",
    "live_ranking_msg": "Obnova každých 15 sekund. Než se započítají nové hlasy, může to trvat 1-2 minuty",
    "candidate": "Kandidát",
    "current_votes": "Aktuální počet hlasů",
    "click_to_start_voting": "Kliknutím zde zahájíte hlasování",
    "votes_remaining_message": "Zbývá hlasů",
    "open_wallet_start_voting_message": "Otevřete peněženku a začněte hlasovat",
    "thanks_submitting_vote_message": "Děkujeme za odeslání hlasu!",
    "need_min_trx_to_vote_message": "Abyste mohli hlasovat, potřebujete minimálně 1 TRX",
    "to_much_votes_massage": "Vyplýtvali jste příliš mnoho hlasů!",
    "all_votes_are_used_message": "Využili jste všechny hlasy!",
    "submissing_vote_message_title": "Děkujeme za hlasování!",
    "submissing_vote_message_0": "Vaše hlasy byly úspěšně odeslány, budou zaúčtovány po začátku nového hlasovacího cyklu.",
    "submissing_vote_message_1": "Své hlasy můžete přerozdělit, kdykoliv se vám bude chtít",
    "submitting_vote_error_message": "Během odesílání hlasů došlo k chybě. Prosím, zkuste to později.",
    ...
    ##################################################################################
    */
    "info_tx_viewer": "Zde můžete vložit hex transakce pro kontrolu obsahu transakce. transakce může být poté odeslána do sítě",
    "load_tx": "Load Transaction",
    "tx_qrcode": "QR kód transakce",
    "load_tx_qrcode": "Load Transaction from QR Code",
    "transaction_load_error": "Chyba při načítání transakce",
    "transaction_load_error_message": "Při načítání transakce došlo k chybě. Zkontrolujte, jestli je HEX ve správném formátu",
    "transaction_success_message": "Transakce úspěšně odeslána do sítě",
    "transaction_success": "Transakce úspěšná",
    "transaction_error_message": "Při odesílání transakce do sítě došlo k chybě",
    "transaction_error": "Chyba transakce",
    "confirm_transaction_message": "Opravdu chcete transakci odeslat?",
    "broadcast_transaction_to_network": "Odesílám transakci do sítě",
    /*
    ##################################################################################
    #                                                                                #
    # tools node tester                                                              #
    ...
    ##################################################################################
    */
    "node_tester_msg": "Vložte IP vašeho nódu za účelem testování GRPC připojení",
    "node_tester_stop": "Ukončit testování",
    ...
    */
    ...
    "trying_enable_webcam_message_0": "Chybě při pokusu spustit webkameru.",
    "trying_enable_webcam_message_1": "Zajistěte povolení přístupu k webové kameře.",
    /*
    ##################################################################################
    #                                                                                #
    # help section                                                                   #
    ...
    */
    ...
    "tron_explorer_api": "API TRON prohlížeče",
    ...
    */
    ...
    "login_mobile": "Přihlásit se pomocí mobilního zařízení",
    "create_wallet": "vytvořit peněženku",
    "no_open_wallet": "Žádná otevřená peněženka k zobrazení",
    "new_wallet": "Nová peněženka",
    "password_encr_key_message_0": "Toto heslo šifruje váš soukromý klíč. Nefunguje jako seed k vygenerování vašich soukromých klíčů.",
    "password_encr_key_message_1": "K odemčení peněženky budete potřebovat heslo a soukromý klíč.",
    "strong_password_info": "Je vyžadováno silné heslo",
    "save_keystore_file": "Uložte si váš Keystore soubor",
    "download_keystore_file": "Stáhnout šifrovaný klíč",
    "do_not_lose_it": "Neztraťte ho!",
    "do_not_lose_it_message_0": "Nadace TRON vám nepomůže s obnovou ztraceného klíče.",
    "do_not_share_it": "Nikomu ho neukazujte!",
    "do_not_share_it_message_0": "Pokud použijete tento soubor na škodlivém webu, můžete o všechny mince přijít.",
    "make_a_backup": "Vytvořte si zálohu!",
    "make_a_backup_message_0": "Pro případ kdyby váš notebook shořel.",
    "save_private_key": "Uložte si soukromý klíč",
    "print_paper_wallet": "Vytiskněte si papírovou peněženku",
    "new_wallet_ready_message": "Vaše nová peněženka je připravená",
    "go_to_account_page": "Přejít na účet",
