export const messages = {
    ...
    */
    ...
    "to": "alıcı",
    "value": "değer",
    "total_accounts": "Toplam Hesap adeti",
    "submit": "gönder",
    "send": "aktar",
    "receive": "al",
    "supply": "arz",
    ...
    "enable_desktop_notifications": "Masaüstü Bildirimlerini Aç",
    "desktop_notification_enabled": "Masaüstü Bildirimleri Açıldı!",
    ...
    */
    ...
    "markets": "Piyasalar",
    "tools": "Araçlar",
    "transaction_viewer": "İşlem görüntüleyicisi",
    "node_tester": "Düğüm Test Edicisi",
    "system": "Sistem",
    "news": "Haberler",
    "help": "Yardım",
    "nodes": "Düğümler",
    ...
    */
    ...
    "first_node_sync_message": "İlk düğümün eşleşmesi bekleniyor, lütfen birkaç dakika içinde tekrar deneyin.",
    "last_block": "son blok",
    "blocks_produced": "Üretilen Bloklar",
    "blocks_missed": "Kaçırılan Bloklar",
    "productivity": "üretkenlik",
    "rewards": "ödüller",
    "token_created": "Jeton Yaratıldı",
    "witness": "Şahit",
    ...
    */
    ...
    "name_to_long": "İsim çok uzun",
    "permitted_characters_message": "İsim sadece a-z A-Z 0-9 içerebilir",
    ...
    "voters": "Oy verenler",
    "progress": "gelişim",
    "transactions_count": "{transactions, plural, one {işlem} other {işlemler}}",
    "issuer": "tanımlayan",
    "network": "ağ",
    "current": "mevcut",
   ...
   Bu süre sonunda TRX'i çözüp jeton alıp satabilirsiniz.`,
    ...
    "tokens_unfrozen": "Çözülmüş Jeton Adeti",
    "success_tokens_unfrozen_message": "Jetonlar başarıyla çözüldü",
    "unable_to_unfreeze": "Çözülemedi",
    "Unable_tokens_unfrozen_message": "Jetonlar çözülemedi.",
    "tokens_frozen": "Dondurulmuş Jeton Adeti",
    "successfully_frozen": "Başarı ile donduruldu",
    "name_changed": "Hesap adı değişti",
   ...
   Süper Temsilci başvurusunda ve oylamasında TRX harcanmayacaktır.`,
    ...
    "create_account_confirm_3": "Parolamı kağıt üzerine yazdım",
    ...
    */
    ...
    "abbr_message": "Jeton adının kısaltması",
    "total_supply": "arz edilen adet",
    "issued_token": "tanımlanan jeton",
    "create_token": "Jeton Üret",
    "description": "Tanım",
    "description_url": "Tanım web adresi",
    "quote_token_amount": "Jeton miktarının kotası",
    "base_token_amount": "Temel jeton miktarı",
    "creating_a_token": "Jeton üretiliyor",
    "available": "müsait",
    "testnet": "Test ağı",
   ...
   Oyların son sayımı gece yarısı 00'da yapılacak ve seçilmişlerin listesi güncellenecektir.`,
    ...
    "token_holders": "Jeton Sahipleri",
    "nr_of_Transfers": "Aktarımların sayısı",
    "not_signed_in": "Bu işlevi kullanmak için giriş yapmanız gerekecektir",
    ...
    */
    ...
    "total_issued": "Toplam üretilen",
    "registered": "Kayıtlı",
    "abbreviation": "Kısaltmalar",
    "exchange_rate": "Değişim Oranı",
   ...
   gün geçtikten sonra şahsen çözülebilir. Dondurma işlemi bir gereklilik değildir.`,
    "token_issued_successfully": "Jeton başarılı bir şekilde tanımlandı",
    ...
    */
    ...
    "no_url_error": "Web adresi gereklidir",
    "past_starttime_error": "Başlangıç, geçmiş tarihli olamaz",
    "no_transactions": "İşlem yok",
    "errors_in_form": "Formda hatalar var",
    "token_link_message_0": "Jeton'a Jetonlar sayfasından",
    "token_link_message_1": "birkaç dakika içerisinde",
    "token_link_message_2": "erişilebilecektir",
    ...
    */
    ...
    "load_tx_qrcode": "Kare Koddan İşlem Yükle",
    "transaction_load_error": "İşlem Yükleme Hatası",
    "transaction_load_error_message": "İşlem yüklenirken bir şeyler yanlış gitti. HEX'in doğru biçimde olduğundan emin olunuz",
    "transaction_success_message": "İşlem ağa başarılı bir şekilde yayınlandı",
    "transaction_success": "İşlem Başarılı",
    "transaction_error_message": "İşlem yayınlanmaya çalışılırken bir hata oluştu",
   ...
   "open_wallet": "Sign in",
    ...
    "login_mobile": "Bir mobil cihazla giriş yap",
    "create_wallet": "cüzdan oluştur",
    "no_open_wallet": "Gösterilecek açık cüzdan yok",
    "new_wallet": "Yeni Cüzdan",
    "password_encr_key_message_0": "Bu parola özel anahtarınızı şifreler. Bu parola şifrelerinizin üretilmesi için bir tohum vazifesi görmez.",
    "password_encr_key_message_1": "Hesabınızın şifresini açmak için bu parolaya ve özel anahtarınıza ihtiyacınız olacaktır.",
    "strong_password_info": "Güçlü bir parola gerekmektedir",
    ...
    "make_a_backup_message_0": "Laptop'unuzun yanma ihtimaline karşın",
    "save_private_key": "Özel Anahtarınızı Kaydedin",
