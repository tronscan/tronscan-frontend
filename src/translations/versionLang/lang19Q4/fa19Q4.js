...
export const lang19Q4 = {
    ...
    */
    ...
    "assetsPercent": "%{portion}:بالا {first}~{end} دارندگان",
    "assetsPercentshow": "کل دارایی های {first}~{end}：{usdt} {unit}",
    "holders": "هوادر های توکن",
    "transfersDetailContractAddress": "آدرس قرارداد",
    "transfersDetailHolder": "دارنده",
    ...
    "token_capitalization": "درپوش بازار/جمع",
    ...
    "token_cau_risk": "لطفا مراقب خطرات باشید!",
    //2019-12-10  leon
    ...
    "token_list_count": "تعداد لیست ها",
    //2019-12-15
    ...
    /*
        ...
        ##################################################################################
    */
    "charts_transaction": "تراکنش",
    "charts_circulation": "گردش",
    "charts_address": "آدرس",
    "charts_block": "بلوک",
   ...
   "Supply_amount_TRX_burned_tip1":"هزینه تخریب",    
   "Supply_amount_TRX_burned_tip2":"رسیدگی به تخریب هزینه + تخریب روزانه مستقل (1،000،000،000 TRX)",    
