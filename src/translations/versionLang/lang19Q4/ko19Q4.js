...
export const lang19Q4 = {
    ...
    */
    ...
    "assetsPercent": "톱 {first}~{end} 보유자:{portion}%",
    ...
    "token_hold_user": "보유자",
    "token_capitalization": "유통 시세/총 시세",
    "token_credit_rating": "신용 등급",
    "token_contract": "발행 계약",
    "token_price_new": "가격",
    "token_website": "홈페이지",
    "token_social_link": "미디어 링크",
    "token_credit_rating_rule": "등급 규정 보기",
    "token_issuance_info": "발매 정보",
    "token_market": "마켓",
    "token_contract_tab": "토큰 계약",
    "token_price_issue": "발행 가격",
    "token_Participants": "참여자",
    ...
    */
    ...
    "charts_contract": "계약",
    "charts_SR": "SR",
    "charts_daily_transactions": "매일 거래 기록",
    "charts_total_transactions": "전체 거래 기록",
    "charts_volume_24": "매일 거래량",
    "charts_total_TRX_supply":"TRX 실시간 유통량 및 시세",
    "charts_total_TRX_supply_vote":"투표 보상",
    "charts_average_blocksize":"일일 평균 블록 크기",
    "charts_total_average_blocksize":"누적 블록 크기",
    "charts_daily_energy_consumption": "일일 에너지 소비",
    "charts_daily_energy_contracts": "일일 계약 에너지 소비",
    "charts_daily_contract_calling_profile": "일일 계약 호출 프로필",
    ...
    "freezing_column_energy_ratio_tip": "에너지 획득에 의해 동결 된 TRX 수 / 동결 된 TRX 수",
    "freezing_column_bandwidth_ratio_tip": "대역폭 획득에 의해 동결 된 TRX 수 / 동결 된 TRX 수",
    ...
    "signature_list":"서명 목록",

    // 2019-12-25 xyy
    "transaction_hash":"해시",
    "transaction_status_tip":'SR이 19 개 이상 확인한 거래는 "확인 완료"로 표시됩니다.',
    "transaction_type": "거래 카테고리",
    "transaction_owner_address":"발신 주소",
    "transaction_receiver_address":"리소스 수신 주소",
    "transaction_freeze_num":"동결 수량",
    "transaction_get_resourse":"자원 획득",
    "transaction_recycling_address":"자원 재활용 주소",
    "transaction_unfreeze_num":"동결 해제 수량",
    "transaction_fee":"비용",
    "transaction_consumed_bandwidth_cap_per":"대역폭 개인 소비 한도",
    "transaction_consumed_bandwidth_cap_all":"대역폭 전체 소비 한도",
    "transaction_frozen_day":"동결 일자",
    "transaction_frozen_number":"동결 수량",
    "transaction_unfreeze_time":"동결 해제 시간",
    "transaction_consumed_bandwidth_cap_per_tip":"TRC10 전송에서 한 명의 사용자에 대한 토큰 보유자의 대역폭 소비 한도",
    "transaction_consumed_bandwidth_cap_all_tip":"TRC10 전송에서 토큰 소유자 대역폭의 전체 소비 한도",
    "transaction_activate_account":"활성화 된 주소",
    "transaction_TRANSFERCONTRACT":"TRX 전송",
    "transaction_FREEZEBALANCECONTRACT":"자산 동결",
    "transaction_UNFREEZEBALANCECONTRACT":"자산 동결 해제",
    "transaction_TRANSFERASSETCONTRACT":"TRC 10 전송",
    "transaction_ASSETISSUECONTRACT":"TRC 10 토큰 발행",
    "transaction_PARTICIPATEASSETISSUECONTRACT":"TRC 10 토큰 매입",
    "transaction_UNFREEZEASSETCONTRACT":"TRC 10 토큰 동결 해제",
    "transaction_UPDATEASSETCONTRACT":"TRC10 토큰 매개 변수 업데이트",
    "transaction_ACCOUNTCREATECONTRACT":"계정 활성화",
    "transaction_WITHDRAWBALANCECONTRACT":"보상 청구",
    "transaction_TRIGGERSMARTCONTRACT":"스마트 계약 트리거",
    "transaction_VOTEWITNESSCONTRACT":"투표",
    "transaction_WITNESSCREATECONTRACT":"SR 후보 신청",
    "transaction_WITNESSUPDATECONTRACT":"SR 후보 정보 업데이트",
    "transaction_ACCOUNTUPDATECONTRACT":"계정 명칭 수정",
    "transaction_PROPOSALCREATECONTRACT":"제안서 작성",
    "transaction_PROPOSALAPPROVECONTRACT":"제안 찬성",
    "transaction_PROPOSALDELETECONTRACT":"제안 취소",
    "transaction_SETACCOUNTIDCONTRACT":"계정 ID 설정",
    "transaction_CREATESMARTCONTRACT":"스마트 계약 작성",
    "transaction_UPDATESETTINGCONTRACT":"계약 매개 변수 업데이트",
    "transaction_EXCHANGECREATECONTRACT":"Bancor 거래 작성",
    "transaction_EXCHANGEINJECTCONTRACT":"Bancor 거래 자금 투입",
    "transaction_EXCHANGEWITHDRAWCONTRACT":"Bancor 거래 자금 철수",
    "transaction_EXCHANGETRANSACTIONCONTRACT":"Bancor 거래 실행",
    "transaction_ACCOUNTPERMISSIONUPDATECONTRACT":"계정 권한 업데이트",
    "transaction_UPDATEENERGYLIMITCONTRACT":"계약 에너지 한계 업데이트",
   ...
   /*
        ...
        ##################################################################################
    */
   "txns_contract_calls":"계약 호출 거래수",
   "txns_TRX_transfers":"TRX 이체 거래수",
   "txns_TRC10_transfers":"TRC10 이체 거래수",
   "txns_frozen_transactions":"동결 거래수",
   "txns_votes_transactions":"투표 거래수",
   "txns_other_transactions":"기타 거래수",
   "txns_shielded_transactions":"익명 거래수",
   "chart_network_resources":"네트워크 리소스",
   "chart_active_accounts":"네트워크",
   "chart_network":"네트워크",
