...
export const lang20Q1 = {
  ...
  */
  ...
  // 2020-03-03 leon
  account_total_tip: "Отображаются только первые 10000 записей, отсортированных по убыванию баланса TRX по умолчанию.",
  account_rank: "№",
  // account_title: "账户",
  ...
  account_vote_self_percent_tip: "Голоса за SR с этого аккаунта / общее количество голосов, поданных за этот аккаунт",
  account_vote_total_percent_tip: "Голоса за SR с этого аккаунтом/общее количество голосов, полученных SR",
  ...
  account_freeze_resource_amount_tip: "Фактический объем полученных ресурсов зависит от отношения текущей замороженной суммы к общей замороженной сумме. Поскольку общая замораженная сумма в реальном времени изменяется, фактические полученные ресурсы будут постоянно меняться.",
