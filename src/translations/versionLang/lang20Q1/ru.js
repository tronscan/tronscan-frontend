...
export const lang20Q1 = {
  ...
  data_token: "Токены",
  data_contract: "Контракты",
  data_recourse: "Ресурсы",
  data_time1: "1 Час",
  data_time2: "1 День",
  data_time3: "1 Неделя",
  ...
  data_token_transcation_accounts: "Топ Токены -- Аккаунт Транзакций ",
  data_token_transcation_items: "Количество Транзакции",
  ...
  data_token_mark_7:
    "(Количество держателей последнего периода - количество владельцев этого периода) / количество владельцев последнего периода * 100%",
  data_token_mark_8:
    "(Количество транзакций аккаунта за последний период - количество транзакций аккаунта за этот период) / количество транзакций аккаунта за последний период * 100%",
  data_token_mark_9:
    "(Количество транзакций за этот период - количество транзакций за последний период) / количество транзакций за последний период * 100%",
  data_token_mark_10:
  ...
  */
  ...
  // active account
  chart_active_account:'Активное распространение аккаунта',
  chart_active_button_1:'MAU',
  chart_active_button_2:'WAU',
  chart_active_button_3:'DAU',
  chart_active_total_month:'Данные ежемесячных активных аккаунтов: {total} результатов',
  chart_active_total_week:'Данные еженедельных активных аккаунтов: {total} результатов',
  chart_active_total_day:'Данные ежедневных активных аккаунтов: {total} результатов',
  chart_active_table_1:'Дата (UTC)',
  chart_active_table_2:'Активные аккаунты',
  chart_active_table_3:'Процент',
  chart_active_table_4:'Изменение',
  chart_active_table_5:'Счет транзакций',
  chart_active_table_6:'Торговый объем',
  chart_active_per_tip_month:'Активные аккаунты месяца / Всего аккаунтов за последний день месяца',
  chart_active_per_tip_week:'Активные аккаунты недели / Всего аккаунтов за последний день недели',
  chart_active_per_tip_day:'Активные аккаунты дня / Всего аккаунтов дня',
  chart_account_add_total:'Всего аккаунтов',
  chart_account_add_per:'Ежедневные новые аккаунты',
  chart_per_price_open:'Открые',
