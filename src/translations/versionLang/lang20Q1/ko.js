...
export const lang20Q1 = {
  ...
  data_items: "횟수",
  data_piao: "표수",
  data_token_holders: "최고 토큰-- 보유 계정",
  ...
  proposal_approve: "찬성",
  proposal_cancel_approve: "찬성 취소",
  proposal_not_sign_in: "이 기능을 사용하려면 로그인하세요",
  ...
  proposal_super_votes: "SR 투표수",
  proposal_super_partner_votes: "SR 파트너 투표수",
  proposal_super_candidate_votes: "SR 후보 투표수",
  proposal_my_initiate: "시작",
  ...
  */
  ...
  // active account
  chart_active_account:'활성계정분포',
  chart_active_button_1:'월평균',
  chart_active_button_2:'주평균',
  chart_active_button_3:'일평균',
  chart_active_total_month:'계정 월간 활성데이터 총 {total}건',
  chart_active_total_week:'계정 주간 활성데이터 총 {total}건',
  chart_active_total_day:'계정 일간활성데이터 총 {total}건',
  chart_active_table_1:'날짜 (UTC)',
  chart_active_table_2:'활성계정수',
  chart_active_table_3:'비율',
  chart_active_table_4:'대비',
  chart_active_table_5:'거래건수',
  chart_active_table_6:'거래량',
  chart_active_per_tip_month:'월간 활성화계정수/월 마지막날 총 계정수',
  chart_active_per_tip_week:'주간 활성계정수/주 마지막날 총 계정수',
  chart_active_per_tip_day:'일 활성계정수/당일 총 계정수',
  chart_account_add_total:'총 계정수',
  chart_account_add_per:'일일 신규계정',
  chart_per_price_open:'개장가',
