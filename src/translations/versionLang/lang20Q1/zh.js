...
export const lang20Q1 = {
  ...
  data_whole_contract_use: "消耗合约部署者提供的能量",
  ...
  proposal_votes_tip:
    "有效票是前27名超级代表所投的票，总得票是所有超级代表投的票",
  proposal_action: "操作",
  proposal_more: "查看详情",
  proposal_approve: "赞成",
  proposal_cancel_approve: "取消赞成",
  proposal_not_sign_in: "使用该功能必须登录，您暂未登录！",
  proposal_cancel_tip: "您确定取消赞成该提议？",
  proposal_apply_super: "该功能仅对超级代表开放，您暂时无法使用！",
  proposal_apply_super_btn: "申请成为超级代表",
  proposal_apply_super_desc:
    "每个TRX持有者都可以申请成为超级代表候选人，获得投票数最高的前27名候选人将成为超级代表，第28～127名成为超级代表合伙人。超级代表有出块和打包交易的义务，同时也会获得相应的投票和出块奖励。超级代表合伙人不参与出块和打包交易，仅可以获得投票奖励。所有超级代表候选人、超级代表合伙人和超级代表，都有权利发起提议来修改TRON网络参数。",
  ...
  proposal_my: "我的",
  proposal_details: "投票详情",
  proposal_super_votes: "超级代表投票数",
  proposal_super_partner_votes: "超级代表合伙人投票数",
  proposal_super_candidate_votes: "超级代表候选人投票数",
  ...
  */
  ...
  proposal_create_info:
    "提议是指对TRON网络参数进行修改，每个超级代表都具有提议权、对提议的投票权。当提议在有效期内获得19个及以上超级代表的赞成票时，该提议获得通过，并在下个维护期内进行网络参数修改。",
  ...
  getAllowTvmSolidity059_tips:
    "TVM（TRON虚拟机）的三个新功能将被打开：支持并行签名验证，多签名验证以及判断地址是否为合约地址。",

  // 2020-03-03 leon
  account_total_tip: "仅展示前10000条，默认按TRX余额降序排列",
  account_rank: "序号",
  // account_title: "账户",
  account_balance: "TRX总余额",
  account_percent: "占比",
  ...
  account_representative_block_ratio_tip: "实际出块数量与应出块数量的比值",
  ...
  fill_a_valid_ledger_note:
    "请确认ledger设置里的Transactions Data选项处于允许状态，否则无法发送备注",
  ...
  chart_active_total_month:'账户月活跃数据共{total}条',
  chart_active_total_week:'账户周活跃数据共{total}条',
  chart_active_total_day:'账户日活跃数据共{total}条',
  ...
  chart_active_per_tip_month:'月活跃账户数/月对应最后一日账户总数',
  chart_active_per_tip_week:'周活跃账户数/周最后一日账户总数',
  chart_active_per_tip_day:'日活跃账户数/当日账户总数',
  chart_account_add_total:'账户总数',
  chart_account_add_per:'每日新增',
  chart_per_price_open:'开盘价',
