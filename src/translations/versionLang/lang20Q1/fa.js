...
export const lang20Q1 = {
  ...
  data_account_receive_Trx: "حساب های برتر - کل TRX دریافت شده است.",
  data_account_receive_Trx_items: "حساب های برتر - تعداد Txn دریافت شد",
  data_account_freeze: "حساب های برتر - فریز TRX.",
  data_account_vote: "حساب های برتر - آرا",
  data_range: "مرتب سازی",
  data_number: "مقدار ",
  data_per: "درصد",
  data_total: "کل",
  data_items: "تعداد Txn",
  data_piao: "آرا",
  data_token_holders: "نشانه های برتر - دارندگان",
  ...
  data_contract_trx_number: "قراردادهای برتر - تراز TRX",
  data_contract_accounts: "تعداد تماس با حساب",
  data_contract_numbers: "موجودی کل ",
...
/*
  ...
  */
  ...
  account_rank: "شماره",
  // account_title: "账户",
  account_balance: "مجموع موجودی TRX",
  account_percent: "درصد",
  account_percent_tip: "TRX توسط این حساب برگزار می شود / تامین کل TRX",
  ...
  account_vote_voter_total: " این حساب به {num} سوپرنماینده ها رای داده است.",
  account_vote_candidate_total: "{votes} آرا توسط رای دهندگان {num}",
  ...
  account_freeze_other_to: "از دیگر کاربران (بازدید کنندگان)",
  account_freeze_time: "زمان فریز",
  account_freeze_address: "حساب فریز",
  account_freeze_received: "دریافت حساب",
  account_freeze_type: "نوع منابع دریافت شده",
