...
export const lang20Q1 = {
  ...
  data_token: "Tokens",
  data_contract: "Contratos",
  data_recourse: "Recursos",
  data_time1: "1 hora",
  data_time2: "1 día",
  data_time3: "1 semana",
  ...
  data_account_receive_Trx: "Top cuentas--TRX total recibido",
  data_account_receive_Trx_items: "Top cuentas--recuento de txn recibido",
  data_account_freeze: "Top cuentas--TRX Frozen",
  data_account_vote: "Top cuentas--Votos",
  data_range: "Rank",
  data_number: "Cantidad",
  data_per: "Porcentaje",
  data_total: "Total",
  data_items: "Txn",
  data_piao: "Votos",
  ...
  data_token_circle_per: "Cambiado por",
  data_contract_trx_number: "El mejor contrato--TRX saldo",
  data_contract_accounts: "El mejor contrato--asignar número de cuenta",
  ...
  proposal_apply_super_btn: "Aplicar para ser un SR",
  proposal_apply_super_desc: "Todos los holders de TRX pueden postularse para ser candidatos SR.  Los 27 candidatos más votados son SR de TRON, y los 28 a 127 candidatos son súper socios. Los SR son responsables de empacar las transacciones y generar bloques. También tienen derecho a recibir recompensas de producer bloques y de votación. Los súper socios no empacan transacciones ni generan bloques, ellos reciben recompensas de votación. Todos los candidatos SR, súper socios y SR pueden plantear propuestas para modificar parámetros en la red de TRON.",
  // proposal_apply_super_input_name: "请输入您的名称",
  // proposal_apply_super_input_name_ph: "3-30个字符，设置后不可修改",
  proposal_apply_super_input_website: "Por favor ingrese su URL",
  proposal_apply_super_input_website_ph: "ingrese un enlace al sitio web del proyecto o la página de redes sociales",
  proposal_apply_super_success: "Aplica con éxito. Las funciones SR ahora están habilitadas.",
  proposal_my: "Mi",
  proposal_details: "Detalles de votos",
  proposal_super_votes: "Votos de SR  ",
  proposal_super_partner_votes: "Votos de SR partner",
  proposal_super_candidate_votes: "Votos de SR candidatos",
  proposal_my_initiate: "Iniciado",
  ...
  */
  ...
  proposal_validate_text_9:"Por favor, introduzca un valor entre 0-100000000000000000",
  proposal_validate_text_10:"Por favor seleccione prohibir / no prohibir",
  ...
  // 0227 torn sr
  sr_vote_team_information:'Equipo',
  sr_vote_last_ranking:'Último ranking',
  sr_vote_last_votes:'Ultimos votos',
  ...
  account_rank: "No.",
  // account_title: "账户",
  account_balance: "Saldo total de TRX",
  account_percent: "Porcentaje",
  account_percent_tip: "TRX en poder de esta cuenta / suministro total de TRX",
  account_power: "TRX congelado (derechos de votar)",
  account_trade_count: "Número de transacción",
  account_trade_count_tip: "Número de transacciones relacionadas con esta dirección",
  account_more: "Ver más",
  account_lastDay_count: "Nuevas cuentas del día anterior.",
  account_realTime_count: "Número de cuentas en tiempo real",
  // account_all: "全部",
  // account_vote_reward: "累计获得奖励",
  account_vote_voter_total: "Esta cuenta ha votado por {num} SR.",
  account_vote_candidate_total: "{votes} votos de {num} votantes",
  account_vote_self_percent_tip: "La proporción de usuarios que votaron por este SR a sus votos totales",
  account_vote_total_percent_tip: "Votos para el SR de esta cuenta / votos totales recibidos por el SR",
  account_vote_reward_tip: "Ganancias acumuladas de votar por este súperrepresentante",
  account_get_reward: "Colectar",
  account_freeze_detail: "Detalles de congelación de tokens",
  account_freeze_self: "Para uso personal",
  account_freeze_to_other: "Para otros usuarios",
  account_freeze_other_to: "De otros usuarios",
  account_freeze_time: "Tiempo de congelación",
  account_freeze_address: "Cuenta congelada",
  account_freeze_received: "Cuenta para recibir",
  account_freeze_type: "Tipo de recursos recibidos",
  account_freeze_amount: "Cantidad congelada",
  account_freeze_resource_amount: "Cantidad de recursos recibidos",
  account_freeze_resource_amount_tip: "La cantidad real de recursos recibidos depende de la relación entre la cantidad de congelación actual y la cantidad de congelación general. Como la cantidad de congelación general en tiempo real varía, los recursos reales recibidos cambiarán constantemente.",
  account_freeze_no_data: "No información encontrada",

  // 2020-03-03
  account_resource_last: "Última ronda",
  account_resource_realTime: "Ronda actual",
  account_resource_remain: "El resto",
  ...
  account_representative_block_table_res: "Recursos consumidos",
  account_representative_block_table_prize: "Recompensas de producir bloques",
  ...
  get_usdj_guide: "Cómo obtener USDJ",
 ...
 account_tags_rec:"Etiqueta certificada por la plataforma",
  ...
  // active account
  chart_active_account:'Distribución de cuenta activa',
  chart_active_button_1:'MAU',
  chart_active_button_2:'WAU',
  chart_active_button_3:'DAU',
  chart_active_total_month:'Datos sobre cuentas activas mensuales: {total} resultados',
  chart_active_total_week:'Datos sobre cuentas activas semanales: {total} resultados',
  chart_active_total_day:'Datos sobre cuentas activas diarias: {total} resultados',
  chart_active_table_1:'Fecha (UTC)',
  chart_active_table_2:'Cuentas activas',
  chart_active_table_3:'Porcentaje',
  chart_active_table_4:'Cambiado por',
  chart_active_table_5:'Recuento de Txn',
  chart_active_table_6:'Volumen de comercio',
  chart_active_per_tip_month:'Cuentas activas del mes / Total de cuentas por último día del mes',
  chart_active_per_tip_week:'Cuentas activas de la semana / Total de cuentas por último día de la semana',
  chart_active_per_tip_day:'Cuentas activas del día / Cuentas totales del día',
  chart_account_add_total:'Número total de cuentas',
  chart_account_add_per:'Cuentas nuevas diarias',
  chart_per_price_open:'Abierto',
  ...
  chart_single_title_max:'El número máximo de {title} es <strong>{number}</strong>. Fecha de registración {date}',
  chart_single_title_min:'El número mínimo de {title} es <strong>{number}</strong>.  Fecha de registración {date}',
  chart_per_price:'Historia de Precio de TRX',
// foundation address
