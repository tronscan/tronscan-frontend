...
export const lang20Q1 = {
  ...
  */
  ...
  // active account
  chart_active_account:'Active account distribution',
  chart_active_button_1:'MAU',
  chart_active_button_2:'WAU',
  chart_active_button_3:'DAU',
  chart_active_total_month:'Data on monthly active accounts: {total} results',
  chart_active_total_week:'Data on weekly active accounts: {total} results',
  chart_active_total_day:'Data on daily active accounts: {total} results',
  chart_active_table_1:'Date (UTC)',
  chart_active_table_2:'Active accounts',
  chart_active_table_3:'Percentage',
  chart_active_table_4:'Changed by',
  chart_active_table_5:'Txn count',
  chart_active_table_6:'Trading volume',
  chart_active_per_tip_month:'Active accounts of the month/Total accounts by the last day of the month',
  chart_active_per_tip_week:'Active accounts of the week/Total accounts by the last day of the week',
  chart_active_per_tip_day:'Active accounts of the day/Total accounts of the day',
  chart_account_add_total:'Total accounts',
  chart_account_add_per:'Daily new accounts',
  chart_per_price_open:'Open',
