export const messages = {
    ...
    */
    ...
    "exchange": "거래소",
    "next": "다음",
    "copied_to_clipboard": "클립보드로 복사 완료",
    "cancel": "취소",
    "reset": "리셋",
    "error": "에러",
    "unlock_keyFile": "키파일 열기",
    ...
    */
    ...
    "block_height": "블록 길이",
    "online_nodes": "온라인 노드",
    "pice_per_1000trx": "가격 (TRX 1000개당)",
    "vote_for_super_representatives": "슈퍼 대표(SR)에 투표하기",
    ...
    */
    ...
    "name_to_long": "이름이 너무 깁니다",
    "permitted_characters_message": "이름은 알파벳과 숫자로만 가능합니다",
    "change_name": "이름 변경",
    "account_name": "계정 이름",
    ...
    "current": "현재",
    "trx_received": "TRX 받음",
    "test_trx_temporarily_unavailable_message": "테스트용 TRX가 임시적으로 사용 이용불가능합니다. 나중에 다시 시도해주십시오.",
    ...
    */
    ...
    "unable_unfreeze_trx_message": "동결 최소 기간이 아직 지나지 않아 TRX를 동결 해제할 수 없습니다.",
    "freeze_trx_premessage_0": `TRX를 동결 및 잠금 설정하여 트론 파워를 얻고, 추가 기능들을 활성화시킬 수 있습니다. 예를 들면, 트론 파워로 다음이 가능합니다: `,
    "freeze_trx_premessage_link": "슈퍼 대표(SR)에 투표하기.",
    "freeze_trx_premessage_1": `동결된 토큰은 3일 동안 "락(locked)" 될 것입니다. 이 기간동안 동결된 TRX는 거래(트레이딩)가 불가능합니다. 이 기간이 지나면, TRX를 동결 해제할 수 있으며 다시 거래를 할 수 있게됩니다.`,
    "trx_amount": "TRX 수량",
    "token_freeze_confirm_message_0": "최소 3일 동안 ",
    "token_freeze_confirm_message_1": "을 동결 상태로 만들것임을 확인합니다",
    "frozen_supply": "동결 수량",
    "tokens_unfrozen": "토큰 동결 해제",
    "success_tokens_unfrozen_message": "성공적으로 동결 해제 하였습니다:",
    "unable_to_unfreeze": "동결 해제 불가능",
    "Unable_tokens_unfrozen_message": "토큰의 동결 상태를 해제할 수 없습니다.",
    "tokens_frozen": "토큰 동결 됨",
    "successfully_frozen": "성공적으로 동결하였습니다:",
    "name_changed": "이름 변경 성공",
    "successfully_changed_name_to_message": "성공적으로 이름을 다음과 같이 변경하였습니다",
    ...
    */
    ...
    "apply_for_delegate_predescription": `토큰 소유자는 트론의 슈퍼 대표(SR)가 될 수 있는 기회를 가집니다. 하지만 네트워크 및 커뮤니티가 보다 원활하고 효율적으로 운영되기 위해 자격을 갖춘 후보자가 추천 슈퍼 위임자가 될 수 있도록 표준 및 규정 기준을 만들었습니다. 우리는 그들이 선출되기 위한 가능성을 높이도록 추천하는 슈퍼 대표를 홍보할 것입니다. 새로운 추천된 슈퍼 대표들은 일주일에 한 번씩 업데이트됩니다.`,
    "apply_for_delegate_description": `
    트론 소지자는 계정 관리 기능을 사용하여 슈퍼 대표로 신청하고 후보자에게 투표할 수 있습니다.
    ...
    투표 결과는 각 투표주기의 각 계정의 최종 유권자 정보를 기반으로 계산되며 시간은 00:00에서 24:00 사이입니다.
     가장 많은 표를 얻은 TRX 소지자는 슈퍼 대표가 됩니다.
     네트워크에서 이루어진 모든 거래는 모든 슈퍼 대표들에 의해 검증되어야 하며 일부 보너스를 받을 수 있습니다.
     TRX는 슈퍼 대표 신청 및 투표 과정에서 소비되지 않습니다.`,
    ...
    */
    ...
    "trx_token_fee_message": "토큰을 발행하기 위해서는 1024 TRX가 필요합니다.",
    "trx_token_account_limit": "한 계정당 만들 수 있는 토큰은 1개입니다",
    "trx_token_wallet_requirement": "토큰을 생성하기 위해서는 지갑을 열어야합니다",
    "invalid_address": "잘못된 주소",
    "insufficient_tokens": "불충분한 토큰",
    "fill_a_valid_number": "올바른 숫자를 넣어주십시오",
    "fill_a_valid_address": "올바른 주소를 넣어주십시오",
    "make_another_transaction": "다른 트랜잭션 만들기",
    ...
    */
    ...
    "exchange_rate": "교환 비율",
    "token_price": "토큰 가격",
    "supply_message": "유통될 토큰의 총 수량",
    "description_message": "토큰의 목적에 대한 짤막한 설명",
    "url_message": "토큰에 대해 좀 더 많은 정보를 찾을 수 있는 웹사이트 주소",
    "exchange_rate_message_0": "참여자가 매 TRX마다 받을 수 있는 토큰의 개수를 정의하기 위해 토큰의 개별 가격을 지정하십시오.",
    "exchange_rate_message_1": "참여자는 다음과 같이 받습니다:",
    "exchange_rate_message_2": "마다",
    "exchange_rate_message_3": "TRX",
    "participation_message_0": "토큰 발행이 이루어지는 참여 기간을 설정하십시오. 참여 기간동안 사용자들은 TRX를 ",
    "participation_message_1": " 토큰으로 교환할 수 있습니다.",
    "frozen_supply_message_0": `동결할 수 있는 수량. 수량은 지정가능하며, 반드시 최소 1일동안은 동결되어야합니다. 동결된 수량은 (시작일+동결지속일) 이후에 동결 해제할 수 있습니다. 동결하는 것은 필수사항이 아닙니다.`,
    "token_issued_successfully": "토큰이 성공적으로 생성되었습니다",
    "participation": "참여",
    "start_date": "시작 일자",
    "end_date": "종료 일자",
    ...
    */
    ...
    "thanks_submitting_vote_message": "투표해주셔서 감사합니다!",
    "need_min_trx_to_vote_message": "투표하기 위해서는 최소 1TRX가 필요합니다니",
    "to_much_votes_massage": "투표권을 너무 많이 사용하였습다!",
    ...
    */
    ...
    "load_tx": "트랜잭션 불러오기",
    "tx_qrcode": "트랜잭션 QR코드",
    "load_tx_qrcode": "QR코드로 트랜잭션 불러오기",
    "transaction_load_error": "트랜잭션 불러오기 에러",
    "transaction_load_error_message": "트랜잭션 불러오기에 실패했습니다. HEX값이 올바른 포맷인지 확인해주십시오.",
    "transaction_success_message": "트랜잭션을 성공적으로 네트워크에 브로드캐스팅 하였습니다",
    "transaction_success": "트랜잭션 성공",
    "transaction_error_message": "트랜잭션을 브로드캐스팅하는데에 실패하였습니다.",
   ...
   "open_wallet": "Sign in",
    ...
    "strong_password_info": "더 강력한 암호가 필요합니다.",
    "save_keystore_file": "키스토어(Keystore) 파일을 저장해주십시오.",
    "download_keystore_file": "암호화된 키 다운로드",
    "do_not_lose_it": "잃어버리지 마십시오!",
    "do_not_lose_it_message_0": "잃어버린 키의 복구를 트론 재단은 도와줄 수가 없습니다.",
    "do_not_share_it": "공유하지 마십시오!",
    "do_not_share_it_message_0": "이 파일을 수상한 사이트에서 사용하면 사용자의 자산이 도난당할 수 있습니다.",
    "make_a_backup": "백업하십시오!",
    "make_a_backup_message_0": "사용자의 랩탑에 화재가 발생할 경우와 같이 예기치 못한 상황에 대비하십시오.",
    "save_private_key": "개인키를 저장해주십시오.",
