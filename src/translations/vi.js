export const messages = {
    ...
    */
    ...
    "submit_votes": "xác nhận phiếu bầu",
    ...
    "reset": "Đặt lại",
    "error": "Lỗi",
    "unlock_keyFile": "KeyFile mở khóa",
    ...
    */
    ...
    "markets": "Thị trường",
    "tools": "Công cụ",
    "transaction_viewer": "Trình xem giao dịch",
    "node_tester": "Trình kiểm tra nút",
    "system": "Hệ thống",
    "news": "Tin tức",
    "help": "Hỗ trợ",
    "nodes": "Nút",
    ...
    */
    ...
    "first_node_sync_message": "Đang chờ đồng bộ hóa nút đầu tiên, vui lòng thử lại sau vài phút.",
    "last_block": "khối cuối cùng",
    "blocks_produced": "Các khối được sản xuất",
    ...
    */
    ...
    "voters": "Cử tri",
    "progress": "tiến trình",
    "transactions_count": "{transactions, plural, one {giao dịch} other {nhiều giao dịch}}",
    ...
    */
    ...
    "tokens_unfrozen": "Giải phóng mã token",
    "success_tokens_unfrozen_message": "Đã vô hiệu hóa mã token thành công",
    "unable_to_unfreeze": "Không thể giải phóng",
    "Unable_tokens_unfrozen_message": "Không thể giải phóng mã token.",
    "tokens_frozen": "Đóng băng token",
    "successfully_frozen": "Đóng băng thành công",
    "name_changed": "Tên đã thay đổi",
    ...
    */
    ...
    "abbr_message": "Tên viết tắt cho mã token",
    "total_supply": "tổng nguồn cung",
    "issued_token": "mã token đã phát hành",
    "create_token": "Tạo mã token",
    "description": "Mô tả",
    "description_url": "URL mô tả",
    "quote_token_amount": "Số lượng mã token đã trích dẫn",
    "base_token_amount": "Số lượng mã token cơ bản",
    "creating_a_token": "Tạo mã token",
    "available": "có sẵn",
    "testnet": "Testnet",
   ...
   Phiếu bầu cuối cùng sẽ được kiểm tra vào lúc 24 giờ và danh sách các đại diện sẽ được cập nhật.`,
    ...
    "token_holders": "Người giữ mã token",
    "nr_of_Transfers": "Số lần chuyển",
    "not_signed_in": "Bạn sẽ cần phải đăng nhập để sử dụng chức năng này",
    ...
    */
    ...
    "no_votes_found": "Không tìm thấy phiếu bầu",
    ...
    */
    ...
    "total_issued": "Tổng số đã phát hành",
    "registered": "Đã đăng ký",
    "abbreviation": "Tên viết tắt",
    "exchange_rate": "Tỷ giá",
    "token_price": "Giá mã token",
   ...
   đã đạt tới. Đóng băng nguồn cung là không cần thiết.`,
    "token_issued_successfully": "Mã token đã được phát hành thành công",
    ...
    */
    ...
    "no_url_error": "URL web là bắt buộc",
    ...
    */
    ...
    "live_ranking": "Xếp hạng trực tiếp",
    "live_ranking_msg": "Làm mới sau mỗi 15 giây. Phiếu bầu mới có thể mất đến 1-2 phút trước khi được tính",
    "candidate": "Ứng cử viên",
    "current_votes": "Phiếu bầu hiện tại",
    "click_to_start_voting": "Nhấp vào đây để Bắt đầu bỏ phiếu",
    ...
    */
    ...
    "load_tx_qrcode": "Tải giao dịch từ mã QR",
    "transaction_load_error": "Lỗi tải giao dịch",
    "transaction_load_error_message": "Đã xảy ra lỗi khi cố gắng tải giao dịch. Đảm bảo HEX có định dạng đúng",
    "transaction_success_message": "Đã truyền giao dịch thành công đến mạng",
    "transaction_success": "Giao dịch thành công",
    "transaction_error_message": "Đã xảy ra sự cố khi cố truyền giao dịch",
   ...
   "open_wallet": "Sign in",
    ...
    "login_mobile": "Đăng nhập bằng thiết bị di động",
    "create_wallet": "tạo ví",
    "no_open_wallet": "Không có ví mở để xem",
    "new_wallet": "Ví mới",
    "password_encr_key_message_0": "Mật khẩu này mã hóa khóa riêng của bạn. Điều này không hoạt động như một hạt giống để tạo ra chìa khóa của bạn.",
    "password_encr_key_message_1": "Bạn sẽ cần mật khẩu này và khóa riêng của bạn để có thể mở khóa ví của mình.",
    "strong_password_info": "Yêu cầu mật khẩu mạnh hơn",
    ...
    "make_a_backup_message_0": "Chỉ trong trường hợp máy tính xách tay của bạn được đặt trên lửa.",
    "save_private_key": "Lưu khóa cá nhân của bạn",
