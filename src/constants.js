...
export const NETURL = {
    MAINNET: "https://fouccent.org",
    SUNNET: "https://dappchain.fouccent.org",
...
export const API_URL_SUNNET = "https://dappchainapi.fouccent.org";
...
export const TORNSOCKET = {
    WSSURLMAIN: "wss://apilist.fouccent.org/api/tronsocket",
    WSSURLSUN: "wss://dappchainapi.fouccent.org/api/tronsocket"
};
