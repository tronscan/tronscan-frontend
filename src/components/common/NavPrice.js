       ...
       
        {
          timeoutState?
              <span className="currentTrxPirce">
                  <span style={{margin:'0 4px 0 6px'}}>{tu("index_page_price_time_out")}</span>
                  <img onClick={()=>this.refreshPrice()} style={{display:'inline-block',width:'14px',height:'14px'}} src={require('../../images/home/timeout.svg')} alt=""/>
              </span>
          :
          <span>
              {
