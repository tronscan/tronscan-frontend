...
class NewDateSelect extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      >
        <div className="row">
          ...
          <div className="col-xs-4 col-sm-6 singleTimeRange">
            <div className={`position-absolute mobileTimeRangeWrapper`}  style={{right: "1rem", width: "415px"}}>
              <DatePicker
