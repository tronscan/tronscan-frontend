                          ...
                          <div className="media-body mb-0 d-flex" style={{paddingTop: 1}}>
                            <div className="text-left">
                              ...
                              <div className="text-gray-dark break-word d-flex list-item-word small">
                                ...
                                <AddressLink address={block.witnessAddress} wrapClassName="d-inline-block mr-2 address_max_width"
                                             className="color-tron-100" truncate={false}>
                                    {block.witnessName?block.witnessName:block.witnessAddress}
                                </AddressLink>
                              </div>
                                {
