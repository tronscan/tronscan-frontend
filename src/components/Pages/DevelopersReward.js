...
class developersReward extends Component {
    ...
    customizedColumn = () => {
        ...
        let column = [
            ...
            // },
            {
                title: upperFirst(intl.formatMessage({
                    id: "developers_username"
                })),
                dataIndex: "name",
                key: "name",
                align: "left",
                    ...
                    return ( <
                        div > {
                            record.extraData && record.extraData.imgUrl !== "null" ? ( <
                                ...
                                <
                                img src = {
                                    require(`../../images/developerReward/avatars.png`)
                                }
                                width = "20"
                                height = "20"
                                alt = {
            ...
            },
            {
                title: upperFirst(
                    intl.formatMessage({
                        id: "trc20_cur_order_header_action"
                    })
                ),
                dataIndex: "action",
                key: "action",
    ...
    render() {
        ...
        let tableInfoTip =
            intl.formatMessage({
                id: "table_info_account_tip1"
            }) +
            " " +
            rangeTotal +
            " " +
            intl.formatMessage({
                id: "table_info_account_tip2"
            });
        return ( <
            ...
            div className = "table_pos_search"
            style = {
                {
                    right: "15px"
                }
            ...
            size = "large"
            onSearch = {
                value => this.onSearchChange(value)
            }
            /> < /
            div > <
            ...
            div > {
                total ? ( <
                    p className = "developers_tip_bottom" > {
