                ...
                <ul>
                  <li>
                    Follow the step-by-step guide on how to create a wallet on Tronscan.org{' '}
                      <HrefLink href="https://medium.com/tron-foundation/how-to-create-a-wallet-on-trons-explorer-ee9505a12615">
                        https://medium.com/tron-foundation/how-to-create-a-wallet-on-trons-explorer-ee9505a12615
                      </HrefLink>
                  </li>
                  <li>
                    Or try an alternative wallet, recommended wallets can be found on <HrefLink href="https://tron.network/wallet?lng=en">https://tron.network/wallet</HrefLink>
                    <ul>
                      <li>
                        Winner of the Tron Android Wallet contest. <HrefLink href="https://github.com/Dryec/tron-wallet-android">https://github.com/Dryec/tron-wallet-android</HrefLink>
                      </li>
                      <li>
                        Winner of the Tron Chrome wallet contest. <HrefLink href="https://github.com/Johnsavadkuhi/tron-walletex">https://github.com/Johnsavadkuhi/tron-walletex</HrefLink>
                      </li>
                      <li>
                        Winner of Tron Mac wallet contest. <HrefLink href="https://github.com/zx63/TronWallet">https://github.com/zx63/TronWallet</HrefLink>

                      </li>
                      <li>
                        Winner of Tron Windows wallet contest. <HrefLink href="https://github.com/TronWatch/Desktop-Wallet">https://github.com/TronWatch/Desktop-Wallet</HrefLink>
                      </li>
                      <li>
                        Tron&rsquo;s Wallet CLI. <HrefLink href="https://github.com/tronprotocol/wallet-cli">https://github.com/tronprotocol/wallet-cli</HrefLink>
                      </li>
                    </ul>
                  </li>
                </ul>
