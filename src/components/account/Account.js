...
export default class Account extends Component {
  ...
  render() {
    ...
    let title = 'TRC20-USDT Returns with Generous Rewards from POLONIDEX - 15,000 USDT Awaits!'
    if(intl.locale == 'zh'){
      ...
      title = 'POLONIDEX-USDT重装上阵，惊喜放送10万人民币'
    }
                ...
                <div className="card-body temp-table">
                  ...
                  <div className="account-token-tab">
                    ...
                    <a href="javascript:;"
                      ...
                      {
                          IS_MAINNET?  <a href={`https://poloniex.org`} className="ml-2 float-right" target="_blank"><span className="mr-1"  style={{textDecoration: 'underline'}}>{t("Trade_on_POLONIDEX")}</span>></a>
                          :''
                      }
                  </div>
                  {/* {
