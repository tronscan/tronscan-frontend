...
class IssuedToken extends React.Component {
        ...
        async getAppealRecent10(address) {
            ...
            } = await xhr.get(CONTRACT_MAINNET_API_URL + '/external/trc_appeals/recent?address=' + address)
            if (retCode == 0) {
                this.setState({
                    appealInfo: data.appeal
                })
            }
        }
        ...
        async getToken20Transfer(contract_address) {
            const data = await Client.getTRC20tfs({
                limit: 0,
                start: 0,
                contract_address
            })
        ...
        async getToken20Holder(contract_address) {
            const {
                data
            } = await xhr.get(API_URL + '/api/token_trc20/holders', {
                params: {
                    limit: 0,
                    start: 0,
                    contract_address
        ...
        async get20token() {
            ...
            } = await xhr.get(CONTRACT_MAINNET_API_URL + '/external/trc20tokens?issuer_addr=' + address)
            if (retCode == 0) {
                let arr = []
        ...
        getMarketInfoToken10 = async() => {
            ...
            if (!!id) {
                ...
                } = await xhr.post(`${MARKET_API_URL}/api/token/getTokenInfoByTokenIdOrAddr`, param);
                const {
                    tokenOtherInfo,
                    description,
                    sprice,
        ...
        getMarketToken20Html = (index, item) => {
                ...
                const {
                    ...
                    isShelves,
                    isRemoved
                } = this.getMarketBtnStatus(verifyStatus, isFirstRecommend);
                return <tr className = "line-2" >
                    <
                    td > {
                        isThrough && < i className = "fas fa-check-circle" > < /i> } {!isThrough && < div className = "tip" > 2 < /div >
                    } < /
                td > <
                    td >
                    <
                ...
                td > {
                        marketNoEntry ?
                        MarketProcessing ? < AntdTip title = { <
                            span > {
                                tu('in_progress_tip')
                            } < /span>}> <
                            Tag color = "#E69F4E" > {
                            ...
                            AntdTip >: marketNotThrough ?
                                ...
                                AntdTip title = { <
                                    ...
                                    AntdTip >: (!isThrough && !isShelves && < div > < AntdTip title = { <
                                                span > {
                                                    tu('type_pass_market_tip')
                                                } < /span>}> <
                                                Tag color = "#28a745" > {
                                                    tu('type_pass_through')
                                                } < /Tag> < /
                                                AntdTip > < /div > )
                                            } {
                                                isListNoEntry && < AntdTip title = { <
                                                        span > {
                                                            tu('not_entry_list_tip')
                                                        } < /span>}> <
                                                        Tag color = "#A4A3A3" > {
                                                            tu('not_entry_list')
                                                        } < /Tag> < /
                                                                ...
                                                                isNotThrough && < AntdTip title = { <
                                                                        ...
                                                                        isThrough && < AntdTip title = { <
                                                                                ...
                                                                                isRemoved && < AntdTip title = { <
                                                                                    ...
                                                                                    isShelves && < AntdTip title = { <
                                                                                        span > {
                                                                                            tu('shelves_market_tip')
                                                                                        } < /span>}> <
                                                                                        Tag color = "#171717" > {
                                                                                            tu('shelves')
                                                                                        } < /Tag> < /
                                                                                    ...
                                                                                    td className = "text-light" > {
                                                                                            ...
                                                                                            isListNoEntry || isRemoved || isToAudit || isNotThrough && < div style = {
                                                                                                {
                                                                                                    height: 21
                                                                                                }
                                                                                            } > < /div>
                                                                                        ...
                                                                                        /td> <
                                                                                    td > < /td> <
                                                                                    td > {!marketNoEntry && !isShelves && !marketNotThrough && !MarketProcessing && < div > < a href = {
                                                                                                `${MARKET_HTTP_URL}/exchange?id=${data.pairId}`
                                                                                            }
                                                                                            target = "_blank" > {
                                                                                                tu('check_market_detail')
                                                                                            } < /a></div >
                                                                                        } {
                                                                                            (marketNoEntry && !MarketProcessing && !marketNotThrough) && < div > < span style = {
                                                                                                {
                                                                                                    color: "#C23631",
                                                                                                    cursor: "pointer"
                                                                                                }
                                                                                            ...
                                                                                            onClick = {
                                                                                                () => this.jumpPage(decimals, `/tokens/markets/create/${TOKENTYPE.TOKEN20}/${address}`)
                                                                                            } > {
                                                                                                tu('search_trading_area')
                                                                                            } < /span><span className="float-right"> <
                                                                                            QuestionMark placement = "top"
                                                                                            text = "search_trading_area_tip" / >
                                                                                                <
                                                                                                /span></div >
                                                                                        } {
                                                                                            (MarketProcessing || marketNotThrough) && < div > < span style = {
                                                                                                {
                                                                                                    color: "#A4A3A3"
                                                                                                }
                                                                                            } > {
                                                                                            ...
                                                                                            (isToAudit || marketNoEntry || marketNotThrough || isRemoved || MarketProcessing) && < div > < span style = {
                                                                                                {
                                                                                                    color: "#A4A3A3"
                                                                                                }
                                                                                            } > {
                                                                                                tu('list_trading_area')
                                                                                            } < /span><span className="float-right"> <
                                                                                            QuestionMark placement = "top"
                                                                                            text = "list_trading_area_tip" / >
                                                                                                <
                                                                                                /span></div >
                                                                                        } {
                                                                                            (isNotThrough || isListNoEntry) && < div > < span style = {
                                                                                                {
                                                                                                    color: "#C23631",
                                                                                                    cursor: "pointer"
                                                                                                }
                                                                                            ...
                                                                                            onClick = {
                                                                                                () => this.jumpListEntry(data, address)
                                                                                            } > {
                                                                                                tu('list_trading_area')
                                                                                            } < /span><span className="float-right"> <
                                                                                            QuestionMark placement = "top"
                                                                                                                                                        ...
                                                                                                                                                        isThrough && < AntdTip title = { <
                                                                                                                                                            ...
                                                                                                                                                            isRemoved && < AntdTip title = { <
                                                                                                                                                                ...
                                                                                                                                                                isShelves && < AntdTip title = { <
                                                                                                                                                                    ...
                                                                                                                                                                    /td> <
                                                                                                                                                                td className = "text-light" > {!marketNoEntry &&
                                                                                                                                                                        <
                                                                                                                                                                        div > {
                                                                                                                                                                            isShelves ? tu('shelves_time') : tu('pass_time')
                                                                                                                                                                        }:
                                                                                                                                                                ...
                                                                                                                                                                td > < /td> <
                                                                                                                                                                td > {!marketNoEntry && !isShelves && !marketNotThrough && !MarketProcessing && < div > < a href = {
                                                                                                                                                                        `${MARKET_HTTP_URL}/exchange?id=${marketInfoToken10.pairId}`
                                                                                                                                                                    }
                                                                                                                                                                    target = "_blank" > {
                                                                                                                                                                        tu('check_market_detail')
                                                                                                                                                                    } < /a></div >
                                                                                                                                                                    ...
                                                                                                                                                                    onClick = {
                                                                                                                                                                        () => this.jumpPage(precision, `/tokens/markets/create/${TOKENTYPE.TOKEN10}/${id}`)
                                                                                                                                                                    } > {
                                                                                                                                                                        tu('search_trading_area')
                                                                                                                                                                    } < /span><span className="float-right"> <
                                                                                                                                                                    QuestionMark placement = "top"
...

                                                                                                                                                                {
                                                                                                                                                                    ...
                                                                                                                                                                    onClick = {
                                                                                                                                                                        () => this.jumpListEntry(marketInfoToken10, id)
                                                                                                                                                                    } > {
                                                                                                                                                                        tu('list_trading_area')
                                                                                                                                                                    } < /span><span className="float-right"> <
                                                                                                                                                                    QuestionMark placement = "top"
                                                                                                                                                            ...
                                                                                                                                                            render() {
                                                                                                                                                                ...
                                                                                                                                                                const content = ( <
                                                                                                                                                                    ...
                                                                                                                                                                    HrefLink href = {
                                                                                                                                                                        intl.locale == "zh" ?
                                                                                                                                                                        "https://poloniex.org/zh/" : "https://poloniex.org/"
                                                                                                                                                                    } >
                                                                                                                                                                    Poloni DEX <
                                                                                                                                                                    /HrefLink> < /
                                                                                                                                                                    span > <
                                                                                                                                                                ...
                                                                                                                                                                const mappingBtnItem = (id, currency) => ( <
                                                                                                                                                                    ...
                                                                                                                                                                    onClick = {
                                                                                                                                                                        () => this.openMappingModal(id, currency)
                                                                                                                                                                    } > {
                                                                                                                                                                        tu('main_account_mapping_btn')
                                                                                                                                                                    } < /Button>
                                                                                                                                                                )
                                                                                                                                                                ...
                                                                                                                                                                const mappedBtnItem = ( <
                                                                                                                                                                    Tag color = "#87d068" > {
                                                                                                                                                                        tu('main_account_mapping_success_btn')
                                                                                                                                                                    } < /Tag>
                                                                                                                                                                );
                                                                                                                                                                ...
                                                                                                                                                                const mppingItem = (id, currency, mappedToSideChains) => ( <
                                                                                                                                                                    ...
                                                                                                                                                                    hr className = "my-4" / >
                                                                                                                                                                    <
                                                                                                                                                                    p className = "mapping-title" > {
                                                                                                                                                                        tu('main_account_mapping_title')
                                                                                                                                                                    } < /p> < /
                                                                                                                                                                    div > <
                                                                                                                                                                    ...
                                                                                                                                                                    <
                                                                                                                                                                    p > {
                                                                                                                                                                        tu('main_account_mapping_text')
                                                                                                                                                                    } < /p> <
                                                                                                                                                                    p > {
                                                                                                                                                                        tu('main_account_mapping_text_1')
                                                                                                                                                                    } < /p> <
                                                                                                                                                                    p > {
                                                                                                                                                                        tu('main_account_mapping_text_2')
                                                                                                                                                                    } < /p> < /
                                                                                                                                                                    div > <
                                                                                                                                                                    div > {
                                                                                                                                                                ...
                                                                                                                                                                return ( <
                                                                                                                                                                        div className = "mt-4" > {
                                                                                                                                                                            ...
                                                                                                                                                                            (Boolean(token20List.length) || issuedAsset) && < h4 style = {
                                                                                                                                                                                {
                                                                                                                                                                                    marginBottom: '-0.5rem'
                                                                                                                                                                                }
                                                                                                                                                                            } > {
                                                                                                                                                                                tu('token_input_success_myaccount')
                                                                                                                                                                            } < /h4>} <
                                                                                                                                                                            div > {
                                                                                                                                                                                    issuedAsset &&
                                                                                                                                                                                    <
                                                                                                                                                                                    ...
                                                                                                                                                                                    address = {
                                                                                                                                                                                        issuedAsset.ownerAddress
                                                                                                                                                                                    }
                                                                                                                                                                                    namePlus = {
                                                                                                                                                                                        issuedAsset.name + ' (' + issuedAsset.abbr + ')'
                                                                                                                                                                                    }
                                                                                                                                                                                    /> <
                                                                                                                                                                                    span style = {
                                                                                                                                                                                        {
                                                                                                                                                                                    ...
                                                                                                                                                                                    h4 > {
                                                                                                                                                                                        ...
                                                                                                                                                                                        <
                                                                                                                                                                                        a href = {
                                                                                                                                                                                            "#/tokens/update/" + issuedAsset.id
                                                                                                                                                                                        } >
                                                                                                                                                                                        <
                                                                                                                                                                                        button type = "button"
                                                                                                                                                                                        className = "btn btn-outline-danger btn-sm" > {
                                                                                                                                                                                            tu('updata_token_info')
                                                                                                                                                                                        } < /button> < /
                                                                                                                                                                                    ...
                                                                                                                                                                                    <
                                                                                                                                                                                    div className = "tf-card__header-title" > {
                                                                                                                                                                                        tu('trc20_token_info_Total_Supply')
                                                                                                                                                                                    } < /div> <
                                                                                                                                                                                    div className = "tf-card__header-text" >
                                                                                                                                                                                    <
                                                                                                                                                                                    FormattedNumber value = {
                                                                                                                                                                                        issuedAsset.totalSupply / 10 ** issuedAsset.precision
                                                                                                                                                                                    }
                                                                                                                                                                                    ...
                                                                                                                                                                                    div className = "tf-card__header-text" > < FormattedNumber value = {
                                                                                                                                                                                        issuedAsset.nrOfTokenHolders
                                                                                                                                                                                    }
                                                                                                                                                                                    /></div > {
                                                                                                                                                                ...
                                                                                                                                                                div className = "d-flex" >
                                                                                                                                                                    ...
                                                                                                                                                                    span className = "ml-1" > {
                                                                                                                                                                        ...
                                                                                                                                                                        <
                                                                                                                                                                        span > < FormattedDate value = {
                                                                                                                                                                            issuedAsset.startTime
                                                                                                                                                                        }
                                                                                                                                                                        />{' '}<FormattedTime
                                                                                                                                                                        value = {
                                                                                                                                                                            issuedAsset.startTime
                                                                                                                                                                ...
                                                                                                                                                                style = {
                                                                                                                                                                        {
                                                                                                                                                                            width: issuedAsset.issuedPercentage + '%',
                                                                                                                                                                            backgroundColor: '#d93649'
                                                                                                                                                                        }
                                                                                                                                                                    } >
                                                                                                                                                                    <
                                                                                                                                                                    div className = "text-white" > {
                                                                                                                                                                        issuedAsset.issuedPercentage > 5 ? issuedAsset.issuedPercentage.toFixed(3) + '%' : ''
                                                                                                                                                                    } < /div> < /
                                                                                                                                                                div > <
                                                                                                                                                                    /div> < /
                                                                                                                                                                span > <
                                                                                                                                                                ...
                                                                                                                                                                div > <
                                                                                                                                                                    div className = " ml-3" > {
                                                                                                                                                                        ...
                                                                                                                                                                        <
                                                                                                                                                                        Tag className = "ant-tag-default m-0" > {
                                                                                                                                                                            tu("unfreeze_assets")
                                                                                                                                                                        } < /Tag> < /
                                                                                                                                                                        a > {
                                                                                                                                                                ...
                                                                                                                                                                div >
                                                                                                                                                                    ...
                                                                                                                                                                    <
                                                                                                                                                                    td > {
                                                                                                                                                                        status10.isPassed && < i className = "fas fa-check-circle" > < /i> } {!status10.isPassed && < div className = "tip" > 1 < /div >
                                                                                                                                                                    } < /
                                                                                                                                                                td > <
                                                                                                                                                                    td > < /td> <
                                                                                                                                                                td > {
                                                                                                                                                                ...
                                                                                                                                                                td > {
                                                                                                                                                                        status10.isPassed && < Tag color = "#28a745" > {
                                                                                                                                                                            tu('type_pass')
                                                                                                                                                                        } < /Tag> } {
                                                                                                                                                                        status10.isFailed && < Tag color = "#3d3d3d" > {
                                                                                                                                                                            tu('type_black')
                                                                                                                                                                        } < /Tag> } {
                                                                                                                                                                        status10.isAppealing && < Tag color = "#f5a623" > {
                                                                                                                                                                            tu('type_appeal')
                                                                                                                                                                        } < /Tag> } < /
                                                                                                                                                                        td > <
                                                                                                                                                                        td className = "text-light" > {
                                                                                                                                                                        ...
                                                                                                                                                                        td > <
                                                                                                                                                                        td > {
                                                                                                                                                                            status10.isFailed && < Tag color = "#4a90e2"
                                                                                                                                                                            onClick = {
                                                                                                                                                                                () => this.showModal(issuedAsset.ownerAddress)
                                                                                                                                                                            } > {
                                                                                                                                                                                tu('Appeal')
                                                                                                                                                                            } < /Tag> } < /
                                                                                                                                                                            td > <
                                                                                                                                                                            td > < TokenLink
                                                                                                                                                                            name = {
                                                                                                                                                                                tu('check_token_detail')
                                                                                                                                                                            }
                                                                                                                                                                            id = {
                                                                                                                                                                                issuedAsset && issuedAsset.id
                                                                                                                                                                            }
                                                                                                                                                                            /></td >
                                                                                                                                                                            <
                                                                                                                                                                            /tr>
                                                                                                                                                                            ...
                                                                                                                                                                            Boolean(token20List.length) &&
                                                                                                                                                                                token20List.map((token20Item, index) => {
                                                                                                                                                                                        ...
                                                                                                                                                                                        return <div className = {
                                                                                                                                                                                            `mt-3 tf-card token20`
                                                                                                                                                                                        }
                                                                                                                                                                                        key = {
                                                                                                                                                                                                token20Item.contract_address
                                                                                                                                                                                            } >
                                                                                                                                                                                            <
                                                                                                                                                                                            div className = "mobile-width" >
                                                                                                                                                                                            <
                                                                                                                                                                                        ...
                                                                                                                                                                                        namePlus = {
                                                                                                                                                                                            token20Item.name + ' (' + token20Item.symbol + ')'
                                                                                                                                                                                        }
                                                                                                                                                                                        address = {
                                                                                                                                                                                            token20Item.contract_address
                                                                                                                                                                                        }
                                                                                                                                                                                        ...
                                                                                                                                                                                        status20.isPassed ?
                                                                                                                                                                                            <
                                                                                                                                                                                            a href = {
                                                                                                                                                                                                "#/tokens/update/" + token20Item.contract_address
                                                                                                                                                                                            } >
                                                                                                                                                                                            <
                                                                                                                                                                                            button type = "button"
                                                                                                                                                                                        className = "btn btn-outline-danger btn-sm" > {
                                                                                                                                                                                    ...
                                                                                                                                                                                    <
                                                                                                                                                                                    FormattedNumber value = {
                                                                                                                                                                                        token20Item.total_supply / 10 ** token20Item.decimals
                                                                                                                                                                                    }
                                                                                                                                                                                    maximumSignificantDigits = {
                                                                                                                                                                                        18
                                                                                                                                                                                    }
                                                                                                                                                                                    ...
                                                                                                                                                                                    <
                                                                                                                                                                                    td > {
                                                                                                                                                                                        status20.isPassed && < i className = "fas fa-check-circle" > < /i> } {!status20.isPassed && < div className = "tip" > 1 < /div >
                                                                                                                                                                                    } < /
                                                                                                                                                                                    td > <
                                                                                                                                                                                    td > < /td> <
                                                                                                                                                                                    td > {
                                                                                                                                                                                    ...
                                                                                                                                                                                    td > {
                                                                                                                                                                                        status20.isPassed && < Tag color = "#28a745" > {
                                                                                                                                                                                            tu('type_pass')
                                                                                                                                                                                        } < /Tag> } {
                                                                                                                                                                                        status20.isFailed && < Tag color = "#3d3d3d" > {
                                                                                                                                                                                            tu('type_black')
                                                                                                                                                                                        } < /Tag> } {
                                                                                                                                                                                        status20.isAppealing && < Tag color = "#f5a623" > {
                                                                                                                                                                                            tu('type_appeal')
                                                                                                                                                                                        } < /Tag> } < /
                                                                                                                                                                                        td > <
                                                                                                                                                                                        td className = "text-light" > {
                                                                                                                                                                                        ...
                                                                                                                                                                                        td > <
                                                                                                                                                                                        td > {
                                                                                                                                                                                            status20.isFailed && < Tag color = "#4a90e2"
                                                                                                                                                                                            onClick = {
                                                                                                                                                                                                () => this.showModal(token20Item.contract_address)
                                                                                                                                                                                            } > {
                                                                                                                                                                                                tu('Appeal')
                                                                                                                                                                                            } < /Tag> } < /
                                                                                                                                                                                            td > <
                                                                                                                                                                ...
                                                                                                                                                                {
                                                                                                                                                                    isShowMappingModal && < MappingModal onCancel = {
