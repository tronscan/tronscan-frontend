...
class ExchangeTable extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            transcationObj: {
                id: [],
                linkUrl: {
                    en: "https://support.poloniex.org/hc/en-us/articles/360030644412-TRC20-USDT-Reloaded-with-Powerful-Aid-from-TRXMarket-15-000-USD-Awaits-",
                    zh: "https://support.poloniex.org/hc/zh-cn/articles/360030644412-TRXMarket%E5%8A%A9%E5%8A%9BTRC20-USDT%E9%87%8D%E8%A3%85%E4%B8%8A%E9%98%B5-%E6%83%8A%E5%96%9C%E6%94%BE%E9%80%8110%E4%B8%87%E4%BA%BA%E6%B0%91%E5%B8%81"
                },
                text: {
                    en: "TRC20-USDT Returns with Generous Rewards from Poloni DEX - 15,000 USDT Awaits!",
    ...
    getContent() {
        ...
        const risk_token_desc = ( <
            ...
            <
            a href = {
                activeLanguage == "zh" ? risk_href["zh"] : risk_href["en"]
            }
            target = "_blank" > {
                tu("learn_more")
            } <
    ...
    listItem(item, index, type) {
        ...
        let tokenDetailContent = ( <
                ...
                src = {
                    item.logo ? item.logo : imgDefault
                }
                /> {
                item.fShortName
            } {
                item.source == 1 && ( <
                    img className = "token-safety"
                    src = {
                        require("../../../../../images/market/SafetyLogo.svg")
                    }
                    />
                )
            } <
        ...
        section > <
            ...
            a href = {
                ...
                `https://tronscan.org/#/token20/${item.fTokenAddr}` : `https://tronscan.org/#/token/${item.fTokenAddr}`
            }
        target = "_blank" > {
                intl.formatMessage({
                    id: "learn_more"
    ...
    return ( <
            div className = {
                "content-item " + this.setActiveClass(item, index)
            }
            onClick = {
                () => {
                    this.docodUrl(item);
    ...
    section className = "table-3" > {
            item.up_down_percent.indexOf("-") != -1 ? ( <
                ...
                <
                span className = "col-red bg-color" > {
