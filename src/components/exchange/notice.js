                        ...
                        <div className="exchange-box-right">
                            <div className="exchange__kline p-3 mb-2">
                                ...
                                <div className="exchange-box-right-content">
                                    <div className="content" dangerouslySetInnerHTML={{__html:focus['context'+lg]}}></div>
                                    <div className="social-media">
                                        {
                                            info.map((v,i)=><div key={i} className="item"><span>{v.method}:</span><a href={v.link} target="_blank">{v.link}</a></div>)
                                        }
                                    </div>
                                </div>
                            </div>
