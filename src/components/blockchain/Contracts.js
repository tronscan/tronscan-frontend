    ...
    let column = [
      {
        ...
        render: hash => (
          <Truncate>
            <TransactionHashLink hash={hash}>{hash}</TransactionHashLink>
          </Truncate>
        )
      },
      {
                    ...
                    <Fragment>
                      ...
                      <table className="table table-hover table-striped m-0 transactions-table">
                        ...
                        <tr>
                          ...
                          <th className="d-none d-lg-table-cell" style={{width: 140}}>{tu("created")}</th>
                          <th className="d-none d-sm-table-cell">{tu("address")}</th>
                          <th className="d-none d-md-table-cell" style={{width: 220}}>{tu("contract")}
