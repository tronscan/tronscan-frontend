...
class StatsCharts extends React.Component {
    ...
    updateHash = (id) => {
        window.location.hash = "#/blockchain/stats"
        this.setState({
            scrollsId: id
        });
    }
    ...
    render() {
        ...
        return ( <
            ...
            <
            nav className = "card-header list-style-body-scroll__header navbar navbar-expand-sm fixed-top"
            style = {
                { position: "sticky", zIndex: 10, background: '#f3f3f3', borderBottom: 'none' } } >
            <
            ul className = "nav nav-tabs card-header-tabs navbar-nav" > {
                Object.values(tabs).map(tab => ( <
                    li className = "nav-item scroll-li"
                    key = { tab.id } >
                    <
                    a href = "javascript:"
            ...
            span >
            <
            i className = "fa fa-exchange-alt ml-5 mr-2 " > < /i> { tu("charts_transaction") } <
            /span> <
            /div> <
            ...
            to = "/blockchain/stats/txOverviewStats" >
            <
            span className = "ml-5" > { tu("charts_daily_transactions") } <
            /span> <
            img src = { require("../../../images/chart/Daily-Transactions.png") }
            style = {
                { width: 240, filter: 'grayscale(100%)' } }
            className = "ml-5 mt-2" /
            >
            <
            /Link> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/totalTxns" >
            <
            span className = "ml-5" > { tu("charts_total_transactions") } <
            /span> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/volumeStats" >
            <
            span className = "ml-5" > { tu("charts_volume_24") } <
            /span> <
            ...
            span >
            <
            i className = "fas fa-layer-group ml-5 mr-2" / > { tu("charts_circulation") } <
            /span> <
            /div> <
            div className = "charts-line" > < /div> <
            /div>
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/priceStats" >
            <
            span className = "ml-5" > { tu("charts_average_price") } <
            /span> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/supply" >
            <
            span className = "ml-5" > { tu("charts_total_TRX_supply") } <
            /span> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/charts/OverallFreezingRate" >
            <
            span className = "ml-5" > { tu("charts_overall_freezing_rate") } <
            /span> <
            ...
            span >
            <
            i className = "fa fa-users ml-5 mr-2" / > { tu("contract_code_overview_account") } <
            /span> <
            /div> <
            div className = "charts-line" > < /div> <
            /div> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/addressesStats" >
            <
            span className = "ml-5" > { tu("charts_new_addresses") } <
            /span> <
            ...
            span >
            <
            i className = "fas fa-cubes ml-5 mr-2" / > { tu("charts_block") } <
            /span> <
            /div> <
            div className = "charts-line" > < /div> <
            /div> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/blockSizeStats" >
            <
            span className = "ml-5" > { tu("charts_average_blocksize") } <
            /span> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/blockchainSizeStats" >
            <
            span className = "ml-5" > { tu("charts_total_average_blocksize") } <
            /span> <
            ...
            span >
            <
            i className = "fa fa-file-contract ml-5 mr-2" / > { tu("charts_contract") } <
            /span> <
            /div> <
            div className = "charts-line" > < /div> <
            /div> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/EnergyConsume" >
            <
            span className = "ml-5" > { tu("charts_daily_energy_consumption") } <
            /span> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/EnergyConsumeDistribution" >
            <
            span className = "ml-5" > { tu("charts_daily_energy_contracts") } <
            /span> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/ContractInvocation" >
            <
            span className = "ml-5" > { tu("charts_contract_calling") } <
            /span> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/ContractInvocationDistribution" >
            <
            span className = "ml-5" > { tu("charts_daily_contract_calling_profile") } <
            /span> <
            ...
            span >
            <
            i className = "fas fa-medal ml-5 mr-2" / > { tu("charts_SR") } <
            /span> <
            /div> <
            div className = "charts-line" > < /div> <
            /div> <
            ...
            <
            Link className = "card-title"
            to = "/blockchain/stats/pieChart" >
            <
            span className = "ml-5" > { tu("produce_distribution") } <
            /span> <
