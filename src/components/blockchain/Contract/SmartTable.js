...
export default class SmartTable extends Component {
  ...
  fetch = (params = {}) => {
    ...
    this.loadDatas(params.page, 10).then((datas) => {

      for (let data in datas.transactions) {
        datas.transactions[data].contractType = ContractTypes[datas.transactions[data].contractType];
      }
