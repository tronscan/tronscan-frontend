...
class BTTSupply extends React.Component {
    ...
    loadTotalTRXSupply = async() =>{
        ...
        let total = 9900000000;
        let result=await xhr.get(`${API_URL}/api/jst/graphic`);
    ...
    render() {
        ...
        const chartData = {
            title: intl.formatMessage({id: 'JST_Token_Release_Schedule'}),
            subtitle: intl.formatMessage({id: 'source_JST_team'}),
            exporting: intl.formatMessage({id: 'JST_Token_Release_Schedule'}),
            xAxis: this.getDateByYear(['2020', '2021', '2022', '2023'], 5)
        }
                                                            ...
                                                            <table className="table" style={{marginTop : 10}}>
                                                                ...
                                                                <tr>
                                                                    <th style={{border:0}}>
                                                                        ...
                                                                        <span style={{marginTop:2}}>{tu('JST_distribution_overview')}</span>
                                                                    </th>
                                                                </tr>
                                                                </thead>
                                                                <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td className="text-nowrap">
                                                                        <b>{toThousands(currentTotalSupply)} JST</b>
                                                                    </td>
                                                                </tr>
