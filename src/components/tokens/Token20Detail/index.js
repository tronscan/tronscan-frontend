...
class Token20Detail extends React.Component {
  ...
  loadToken = async (address) => {
    ...
    this.setState({loading: true});
      let result = await xhr.get("https://apilist.tronscan.org"+"/api/token_trc20?contract="+address);
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(Token20Detail));
