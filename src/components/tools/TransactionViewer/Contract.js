                                    ...
                                    {contract.tokenTransferInfo && contract.tokenTransferInfo.decimals !==undefined && contract.tokenTransferInfo.symbol !==undefined && <div className="d-flex border-bottom pt-2">
                                        ...
                                        <div className="flex1">
                                            ...
                                            <div className="d-flex border-bottom content_item">
                                                ...
                                                <div className="flex1">
                                                    {
                                                        contract.tokenTransferInfo['contract_address'] == CONTRACT_ADDRESS_USDT || contract.tokenTransferInfo['contract_address'] == CONTRACT_ADDRESS_WIN || contract.tokenTransferInfo['contract_address'] == CONTRACT_ADDRESS_GGC?
                                        ...
                                        <div className="flex1">
                                            {
                                                Object.keys(contract.internal_transactions).map((o,index) => {
                                                    ...
                                                    contract.internal_transactions[o].map((item,cindex) => {
                                                        ...
                                                        vdom.push(
                                                            <div key={item.transaction_id} className={'d-flex align-items-center content_item'}>
                                                                {/* {
                                    (index> 0&& cindex== 0) &&
                                ...
                                <div className="d-flex border-bottom pt-2">
                                    ...
                                    <div className="flex1">
                                        ...
                                        <div className="d-flex border-bottom content_item">
                                            ...
                                            <div className="flex1">{contract['brokerage']} %</div>
                                        </div>
                                        <div className="d-flex content_item">
                                            <div className="content_name">{tu('value')}:</div>
                                            {
