    ...
    if(contract.contractType){
        ...
        switch (contract.contractType.toUpperCase()) {
            ...
            case "SHIELDEDTRANSFERCONTRACT":{
              ...
              let noSet = ["cost","internal_transactions","map_token_name_abbr","map_token_id","map_token_precision","map_amount","map_amount_logo","map_token_name","contract_note","tokenTransferInfo"]
              return (
                <Fragment>
                <div className="card-body table-title">
                    <h5>
                ...
                <table className="table">
                    <tbody>
                      {contract_arr.map(item=>{
                        if(noSet.includes(item)){
                          return ''
                          // let arr2 = Object.keys(contract[item])
                          // return (<Field label={item}>
                          //    <ul>
                          //      {arr2.map(subItem=>{
                          //        return contract[item][subItem]
                          //      })}
                          //    </ul>
                          // </Field>)
                            ...
                            return (<Field label={item}>
                               ...
                               return (<ul className="mb-2">
                                  <li><span className="receive-item mr-2 text-muted">value_commitment:</span>{subItem && subItem.value_commitment}</li>
                                  <li><span className="receive-item mr-2 text-muted">note_commitment:</span>{subItem && subItem.note_commitment}</li>
                                  <li><span className="receive-item mr-2 text-muted">epk:</span>{subItem && subItem.epk}</li>
                                  <li><span className="receive-item mr-2 text-muted">c_enc:</span>{subItem && subItem.c_enc}</li>
                                  <li><span className="receive-item mr-2 text-muted">c_out:</span>{subItem && subItem.c_out}</li>
                                  <li><span className="receive-item mr-2 text-muted">zkproof:</span>{subItem && subItem.zkproof}</li>
                              </ul>
                              )
                            })} 
                            </Field>)
                          ...
                          return (<Field label={item}>
                             ...
                             return (<ul className="mb-2">
                                <li><span className="receive-item mr-2 text-muted">value_commitment:</span>{subItem && subItem.value_commitment}</li>
                                <li><span className="receive-item mr-2 text-muted">anchor:</span>{subItem && subItem.anchor}</li>
                                <li><span className="receive-item mr-2 text-muted">nullifier:</span>{subItem && subItem.nullifier}</li>
                                <li><span className="receive-item mr-2 text-muted">rk:</span>{subItem && subItem.rk}</li>
                                <li><span className="receive-item mr-2 text-muted">zkproof:</span>{subItem && subItem.zkproof}</li>
                                <li><span className="receive-item mr-2 text-muted">spend_authority_signature:</span>{subItem && subItem.spend_authority_signature}</li>
                            </ul>
                            )
                          })} 
                          </Field>)
